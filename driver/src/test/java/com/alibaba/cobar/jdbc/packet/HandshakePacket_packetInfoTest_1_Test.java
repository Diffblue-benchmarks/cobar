...
public class HandshakePacket_packetInfoTest_1_Test {
  @Test
  public void packetInfoTest() throws Exception {
    ...
    // Act
    String actual = handshakePacket.packetInfo();

    // Assert
    Assert.assertEquals("MySQL Handshake Packet", actual);
    byte[] byteArray = handshakePacket.seed;
    byte[] byteArray1 = handshakePacket.restOfScrambleBuff;
    byte[] byteArray2 = handshakePacket.serverVersion;
