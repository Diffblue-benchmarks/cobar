...
public class ConvertTzTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9991f9fa985bf9288ba() {
    ...
    final ConvertTz thisObj = new ConvertTz(arrayList);
    ...
    Assert.assertNotNull(((ConvertTz) actual).getArguments());
    Assert.assertEquals(1, ((ConvertTz) actual).getArguments().size());
    Assert.assertNotNull(((ConvertTz) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((ConvertTz) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ConvertTz) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((ConvertTz) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ConvertTz) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ConvertTz) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ConvertTz) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ConvertTz) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((ConvertTz) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((ConvertTz) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("CONVERT_TZ", ((ConvertTz) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999f0c2a74754d81d2f() {
    ...
    final ConvertTz actual = new ConvertTz(arg0);
    ...
    Assert.assertEquals("CONVERT_TZ", actual.getFunctionName());
