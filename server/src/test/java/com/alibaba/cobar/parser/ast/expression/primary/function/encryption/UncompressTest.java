...
public class UncompressTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9996748e1b4f5f7c4a4() {
    ...
    final Uncompress thisObj = new Uncompress(arrayList);
    ...
    Assert.assertNotNull(((Uncompress) actual).getArguments());
    Assert.assertEquals(1, ((Uncompress) actual).getArguments().size());
    Assert.assertNotNull(((Uncompress) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Uncompress) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Uncompress) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Uncompress) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Uncompress) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Uncompress) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Uncompress) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Uncompress) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Uncompress) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Uncompress) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("UNCOMPRESS", ((Uncompress) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9995ce704bdd8f9ef2a() {
    ...
    final Uncompress actual = new Uncompress(arg0);
    ...
    Assert.assertEquals("UNCOMPRESS", actual.getFunctionName());
