...
public class CountTest {
  ...
  @Test
  public void acceptInputNotNullOutputVoid9998f5cc1b0f0eb9c18() {

    // Arrange
    final ArithmeticAddExpression arithmeticAddExpression2 = new ArithmeticAddExpression(null, null);
    final ArithmeticAddExpression arithmeticAddExpression1 = new ArithmeticAddExpression(arithmeticAddExpression2, arithmeticAddExpression2);
    final ArithmeticAddExpression arithmeticAddExpression = new ArithmeticAddExpression(arithmeticAddExpression1, null);
    final Count thisObj = new Count(arithmeticAddExpression);
  ...
  // Test written by Diffblue Cover
  @Test
  public void constructFunctionInputNotNullOutputNotNull99900a22e9884eeedd1() {
    ...
    Assert.assertTrue(((Count) actual).isDistinct());
    Assert.assertNotNull(((Count) actual).getArguments());
    Assert.assertEquals(1, ((Count) actual).getArguments().size());
    Assert.assertNotNull(((Count) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Count) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Count) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((Count) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((Count) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("COUNT", ((Count) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9994c7033cf1377779e() {
    ...
    final Count actual = new Count(arg0);

    // Assert result
    Assert.assertNotNull(actual);
    Assert.assertFalse(actual.isDistinct());
    ...
    Assert.assertEquals("COUNT", actual.getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999c45ad8d1cde9eb6a() {
  ...
  // Test written by Diffblue Cover
  @Test
  public void isDistinctOutputFalse99966887b887de87321() {
