...
public class ValuesTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99969604189c514f27c() {
    ...
    final Values thisObj = new Values(arrayList);
    ...
    Assert.assertNotNull(((Values) actual).getArguments());
    Assert.assertEquals(1, ((Values) actual).getArguments().size());
    Assert.assertNotNull(((Values) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Values) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Values) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Values) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Values) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Values) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Values) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Values) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Values) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Values) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("VALUES", ((Values) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999f8da10bfa01c3841() {
    ...
    final Values actual = new Values(arg0);
    ...
    Assert.assertEquals("VALUES", actual.getFunctionName());
