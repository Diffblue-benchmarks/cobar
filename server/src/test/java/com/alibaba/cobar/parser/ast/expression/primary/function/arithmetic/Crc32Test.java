...
public class Crc32Test {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9994118422648a4e668() {
    ...
    final Crc32 thisObj = new Crc32(arrayList);
    ...
    Assert.assertNotNull(((Crc32) actual).getArguments());
    Assert.assertEquals(1, ((Crc32) actual).getArguments().size());
    Assert.assertNotNull(((Crc32) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Crc32) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Crc32) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Crc32) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Crc32) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Crc32) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Crc32) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Crc32) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Crc32) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Crc32) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("CRC32", ((Crc32) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99946eb19bd14a2ae77() {
    ...
    final Crc32 actual = new Crc32(arg0);
    ...
    Assert.assertEquals("CRC32", actual.getFunctionName());
