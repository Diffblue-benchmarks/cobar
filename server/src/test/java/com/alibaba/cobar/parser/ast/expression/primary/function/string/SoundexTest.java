...
public class SoundexTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999195bfd6785f1b802() {
    ...
    final Soundex thisObj = new Soundex(arrayList);
    ...
    Assert.assertNotNull(((Soundex) actual).getArguments());
    Assert.assertEquals(1, ((Soundex) actual).getArguments().size());
    Assert.assertNotNull(((Soundex) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Soundex) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Soundex) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Soundex) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Soundex) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Soundex) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Soundex) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Soundex) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Soundex) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Soundex) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("SOUNDEX", ((Soundex) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999c1d1449cf1c00f3f() {
    ...
    final Soundex actual = new Soundex(arg0);
    ...
    Assert.assertEquals("SOUNDEX", actual.getFunctionName());
