...
public class TimediffTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999e807633cf78a0be0() {
    ...
    final Timediff thisObj = new Timediff(arrayList);
    ...
    Assert.assertNotNull(((Timediff) actual).getArguments());
    Assert.assertEquals(1, ((Timediff) actual).getArguments().size());
    Assert.assertNotNull(((Timediff) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Timediff) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Timediff) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Timediff) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Timediff) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Timediff) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Timediff) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Timediff) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Timediff) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Timediff) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("TIMEDIFF", ((Timediff) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999029834932fd8508e() {
    ...
    final Timediff actual = new Timediff(arg0);
    ...
    Assert.assertEquals("TIMEDIFF", actual.getFunctionName());
