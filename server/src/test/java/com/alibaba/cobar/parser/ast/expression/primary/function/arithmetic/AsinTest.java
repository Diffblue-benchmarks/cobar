...
public class AsinTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999e153ad3e76046858() {
    ...
    final Asin thisObj = new Asin(arrayList);
    ...
    Assert.assertNotNull(((Asin) actual).getArguments());
    Assert.assertEquals(1, ((Asin) actual).getArguments().size());
    Assert.assertNotNull(((Asin) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Asin) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Asin) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Asin) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Asin) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Asin) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Asin) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Asin) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Asin) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Asin) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("ASIN", ((Asin) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999266e95ce465c3436() {
    ...
    final Asin actual = new Asin(arg0);
    ...
    Assert.assertEquals("ASIN", actual.getFunctionName());
