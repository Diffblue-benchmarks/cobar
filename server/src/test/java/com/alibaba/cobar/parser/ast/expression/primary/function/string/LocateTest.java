...
public class LocateTest {
  ...
  @Test
  public void acceptInputNotNullOutputVoid999fabcf7fa168ad6e3() {
    ...
    final Locate thisObj = new Locate(arrayList);
  ...
  // Test written by Diffblue Cover
  @Test
  public void constructFunctionInputNotNullOutputNotNull9997e8e72ef52ae5e3e() {
    ...
    Assert.assertNotNull(((Locate) actual).getArguments());
    Assert.assertEquals(1, ((Locate) actual).getArguments().size());
    Assert.assertNotNull(((Locate) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Locate) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Locate) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Locate) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Locate) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Locate) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Locate) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Locate) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Locate) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Locate) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("LOCATE", ((Locate) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99946a04c0e8de09b64() {
    ...
    final Locate actual = new Locate(arg0);
    ...
    Assert.assertEquals("LOCATE", actual.getFunctionName());
