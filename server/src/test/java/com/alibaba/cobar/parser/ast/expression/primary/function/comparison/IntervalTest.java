...
public class IntervalTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99918a8ebecae457543() {
    ...
    final Interval thisObj = new Interval(arrayList);
    ...
    Assert.assertNotNull(((Interval) actual).getArguments());
    Assert.assertEquals(1, ((Interval) actual).getArguments().size());
    Assert.assertNotNull(((Interval) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Interval) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Interval) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Interval) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Interval) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Interval) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Interval) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Interval) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Interval) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Interval) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("INTERVAL", ((Interval) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9990cb5bb191291ff85() {
    ...
    final Interval actual = new Interval(arg0);
    ...
    Assert.assertEquals("INTERVAL", actual.getFunctionName());
