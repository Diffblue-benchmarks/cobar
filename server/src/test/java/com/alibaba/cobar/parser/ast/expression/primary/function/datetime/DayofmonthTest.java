...
public class DayofmonthTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999bbf9fbf6e3a9f213() {
    ...
    final Dayofmonth thisObj = new Dayofmonth(arrayList);
    ...
    Assert.assertNotNull(((Dayofmonth) actual).getArguments());
    Assert.assertEquals(1, ((Dayofmonth) actual).getArguments().size());
    Assert.assertNotNull(((Dayofmonth) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Dayofmonth) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Dayofmonth) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Dayofmonth) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofmonth) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofmonth) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofmonth) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofmonth) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Dayofmonth) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Dayofmonth) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DAYOFMONTH", ((Dayofmonth) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999c846d3c4079b049d() {
    ...
    final Dayofmonth actual = new Dayofmonth(arg0);
    ...
    Assert.assertEquals("DAYOFMONTH", actual.getFunctionName());
