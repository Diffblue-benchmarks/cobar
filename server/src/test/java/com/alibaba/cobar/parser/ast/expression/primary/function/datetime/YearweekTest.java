...
public class YearweekTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9996260636d1bfa5fd7() {
    ...
    final Yearweek thisObj = new Yearweek(arrayList);
    ...
    Assert.assertNotNull(((Yearweek) actual).getArguments());
    Assert.assertEquals(1, ((Yearweek) actual).getArguments().size());
    Assert.assertNotNull(((Yearweek) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Yearweek) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Yearweek) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Yearweek) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Yearweek) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Yearweek) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Yearweek) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Yearweek) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Yearweek) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Yearweek) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("YEARWEEK", ((Yearweek) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99968969b3a33384e46() {
    ...
    final Yearweek actual = new Yearweek(arg0);
    ...
    Assert.assertEquals("YEARWEEK", actual.getFunctionName());
