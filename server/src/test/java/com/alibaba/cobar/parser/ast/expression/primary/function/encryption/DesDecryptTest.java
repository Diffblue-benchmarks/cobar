...
public class DesDecryptTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999a71b70981bbcbdf7() {
    ...
    final DesDecrypt thisObj = new DesDecrypt(arrayList);
    ...
    Assert.assertNotNull(((DesDecrypt) actual).getArguments());
    Assert.assertEquals(1, ((DesDecrypt) actual).getArguments().size());
    Assert.assertNotNull(((DesDecrypt) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((DesDecrypt) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((DesDecrypt) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((DesDecrypt) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DesDecrypt) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DesDecrypt) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DesDecrypt) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DesDecrypt) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((DesDecrypt) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((DesDecrypt) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DES_DECRYPT", ((DesDecrypt) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99959be86aa1117c329() {
    ...
    final DesDecrypt actual = new DesDecrypt(arg0);
    ...
    Assert.assertEquals("DES_DECRYPT", actual.getFunctionName());
