...
public class SubtimeTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99969c8d6ec5d123c58() {
    ...
    final Subtime thisObj = new Subtime(arrayList);
    ...
    Assert.assertNotNull(((Subtime) actual).getArguments());
    Assert.assertEquals(1, ((Subtime) actual).getArguments().size());
    Assert.assertNotNull(((Subtime) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Subtime) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Subtime) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Subtime) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Subtime) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Subtime) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Subtime) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Subtime) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Subtime) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Subtime) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("SUBTIME", ((Subtime) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99967261c7b1c160327() {
    ...
    final Subtime actual = new Subtime(arg0);
    ...
    Assert.assertEquals("SUBTIME", actual.getFunctionName());
