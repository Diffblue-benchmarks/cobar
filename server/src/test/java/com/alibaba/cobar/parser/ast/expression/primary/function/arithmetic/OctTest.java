...
public class OctTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999eb99233c99753b72() {
    ...
    final Oct thisObj = new Oct(arrayList);
    ...
    Assert.assertNotNull(((Oct) actual).getArguments());
    Assert.assertEquals(1, ((Oct) actual).getArguments().size());
    Assert.assertNotNull(((Oct) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Oct) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Oct) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Oct) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Oct) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Oct) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Oct) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Oct) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Oct) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Oct) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("OCT", ((Oct) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999c91f41f986e414ad() {
    ...
    Assert.assertEquals("OCT", actual.getFunctionName());
