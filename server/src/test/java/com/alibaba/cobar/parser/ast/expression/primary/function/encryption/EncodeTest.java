...
public class EncodeTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999fd59314d2986ac2f() {
    ...
    final Encode thisObj = new Encode(arrayList);
    ...
    Assert.assertNotNull(((Encode) actual).getArguments());
    Assert.assertEquals(1, ((Encode) actual).getArguments().size());
    Assert.assertNotNull(((Encode) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Encode) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Encode) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Encode) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Encode) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Encode) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Encode) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Encode) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Encode) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Encode) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("ENCODE", ((Encode) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999b806037814d501cc() {
    ...
    final Encode actual = new Encode(arg0);
    ...
    Assert.assertEquals("ENCODE", actual.getFunctionName());
