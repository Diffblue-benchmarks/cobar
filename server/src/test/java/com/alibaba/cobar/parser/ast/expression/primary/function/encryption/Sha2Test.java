...
public class Sha2Test {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99976cabaee731671ab() {
    ...
    final Sha2 thisObj = new Sha2(arrayList);
    ...
    Assert.assertNotNull(((Sha2) actual).getArguments());
    Assert.assertEquals(1, ((Sha2) actual).getArguments().size());
    Assert.assertNotNull(((Sha2) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Sha2) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Sha2) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Sha2) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sha2) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sha2) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sha2) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sha2) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Sha2) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Sha2) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("SHA2", ((Sha2) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999704193152aaa34a2() {
    ...
    final Sha2 actual = new Sha2(arg0);
    ...
    Assert.assertEquals("SHA2", actual.getFunctionName());
