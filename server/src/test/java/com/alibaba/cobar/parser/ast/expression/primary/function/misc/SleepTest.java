...
public class SleepTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999f79de4b64141febd() {
    ...
    final Sleep thisObj = new Sleep(arrayList);
    ...
    Assert.assertNotNull(((Sleep) actual).getArguments());
    Assert.assertEquals(1, ((Sleep) actual).getArguments().size());
    Assert.assertNotNull(((Sleep) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Sleep) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Sleep) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Sleep) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sleep) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sleep) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sleep) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sleep) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Sleep) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Sleep) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("SLEEP", ((Sleep) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999e27e16398daf0eee() {
    ...
    final Sleep actual = new Sleep(arg0);
    ...
    Assert.assertEquals("SLEEP", actual.getFunctionName());
