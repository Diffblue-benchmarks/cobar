...
public class BitXORExpressionTest {
  ...
  @Test
  public void acceptInputNotNullOutputVoid99995e3276716c2aa26() {

    // Arrange
    final ArithmeticAddExpression arithmeticAddExpression2 = new ArithmeticAddExpression(null, null);
    final ArithmeticAddExpression arithmeticAddExpression1 = new ArithmeticAddExpression(arithmeticAddExpression2, arithmeticAddExpression2);
    final ArithmeticAddExpression arithmeticAddExpression = new ArithmeticAddExpression(arithmeticAddExpression1, null);
    final BitXORExpression thisObj = new BitXORExpression(arithmeticAddExpression, arithmeticAddExpression1);
  ...
  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullNotNullOutputNotNull999d355923ee9f7e7d1() {
    ...
    final BitXORExpression actual = new BitXORExpression(arg0, arg1);

    // Assert result
    Assert.assertNotNull(actual);
    Assert.assertTrue(actual.isLeftCombine());
    Assert.assertEquals(14, actual.getPrecedence());
  ...
  // Test written by Diffblue Cover
  @Test
  public void getOperatorOutputNotNull99977e2801f15bd7594() {
