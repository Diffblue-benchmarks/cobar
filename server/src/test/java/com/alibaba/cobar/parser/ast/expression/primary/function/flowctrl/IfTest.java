...
public class IfTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9996570c3510c8d4857() {
    ...
    final If thisObj = new If(arrayList);
    ...
    Assert.assertNotNull(((If) actual).getArguments());
    Assert.assertEquals(1, ((If) actual).getArguments().size());
    Assert.assertNotNull(((If) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((If) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((If) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((If) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((If) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((If) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((If) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((If) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((If) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((If) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("IF", ((If) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9990166dc15cb7eb3cb() {
    ...
    Assert.assertEquals("IF", actual.getFunctionName());
