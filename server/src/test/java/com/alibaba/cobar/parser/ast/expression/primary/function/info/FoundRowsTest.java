...
public class FoundRowsTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9991d4448663d2608d0() {
    ...
    final FoundRows thisObj = new FoundRows(arrayList);
    ...
    Assert.assertNotNull(((FoundRows) actual).getArguments());
    Assert.assertEquals(1, ((FoundRows) actual).getArguments().size());
    Assert.assertNotNull(((FoundRows) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((FoundRows) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((FoundRows) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((FoundRows) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FoundRows) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FoundRows) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FoundRows) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FoundRows) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((FoundRows) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((FoundRows) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("FOUND_ROWS", ((FoundRows) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9996f4ecbb3d8814ead() {
    ...
    final FoundRows actual = new FoundRows(arg0);
    ...
    Assert.assertEquals("FOUND_ROWS", actual.getFunctionName());
