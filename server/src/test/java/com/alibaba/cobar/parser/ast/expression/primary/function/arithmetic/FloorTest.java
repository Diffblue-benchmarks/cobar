...
public class FloorTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99940b270c1fb183348() {
    ...
    final Floor thisObj = new Floor(arrayList);
    ...
    Assert.assertNotNull(((Floor) actual).getArguments());
    Assert.assertEquals(1, ((Floor) actual).getArguments().size());
    Assert.assertNotNull(((Floor) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Floor) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Floor) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Floor) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Floor) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Floor) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Floor) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Floor) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Floor) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Floor) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("FLOOR", ((Floor) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999a2b971519a154654() {
    ...
    final Floor actual = new Floor(arg0);
    ...
    Assert.assertEquals("FLOOR", actual.getFunctionName());
