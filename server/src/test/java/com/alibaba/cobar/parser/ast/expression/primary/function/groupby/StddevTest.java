...
public class StddevTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9991b15651bb4506789() {
    ...
    final Stddev thisObj = new Stddev(arrayList);
    ...
    Assert.assertNotNull(((Stddev) actual).getArguments());
    Assert.assertEquals(1, ((Stddev) actual).getArguments().size());
    Assert.assertNotNull(((Stddev) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Stddev) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Stddev) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Stddev) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Stddev) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Stddev) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Stddev) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Stddev) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Stddev) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Stddev) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("STDDEV", ((Stddev) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999570fcd0823ff0635() {
    ...
    final Stddev actual = new Stddev(arg0);
    ...
    Assert.assertEquals("STDDEV", actual.getFunctionName());
