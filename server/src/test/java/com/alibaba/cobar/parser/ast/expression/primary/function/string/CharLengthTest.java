...
public class CharLengthTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999f9c4e090263d5da5() {
    ...
    final CharLength thisObj = new CharLength(arrayList);
    ...
    Assert.assertNotNull(((CharLength) actual).getArguments());
    Assert.assertEquals(1, ((CharLength) actual).getArguments().size());
    Assert.assertNotNull(((CharLength) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((CharLength) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((CharLength) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((CharLength) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((CharLength) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((CharLength) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((CharLength) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((CharLength) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((CharLength) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((CharLength) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("CHAR_LENGTH", ((CharLength) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9998b91a553c3a91a91() {
    ...
    final CharLength actual = new CharLength(arg0);
    ...
    Assert.assertEquals("CHAR_LENGTH", actual.getFunctionName());
