...
public class FromUnixtimeTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99966520088226dfc77() {
    ...
    final FromUnixtime thisObj = new FromUnixtime(arrayList);
    ...
    Assert.assertNotNull(((FromUnixtime) actual).getArguments());
    Assert.assertEquals(1, ((FromUnixtime) actual).getArguments().size());
    Assert.assertNotNull(((FromUnixtime) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((FromUnixtime) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((FromUnixtime) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((FromUnixtime) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FromUnixtime) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FromUnixtime) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FromUnixtime) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FromUnixtime) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((FromUnixtime) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((FromUnixtime) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("FROM_UNIXTIME", ((FromUnixtime) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99939d4015a4f203be7() {
    ...
    final FromUnixtime actual = new FromUnixtime(arg0);
    ...
    Assert.assertEquals("FROM_UNIXTIME", actual.getFunctionName());
