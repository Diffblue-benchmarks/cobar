...
public class VarSampTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9991ea4530b0e8f3da2() {
    ...
    final VarSamp thisObj = new VarSamp(arrayList);
    ...
    Assert.assertNotNull(((VarSamp) actual).getArguments());
    Assert.assertEquals(1, ((VarSamp) actual).getArguments().size());
    Assert.assertNotNull(((VarSamp) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((VarSamp) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((VarSamp) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((VarSamp) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((VarSamp) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((VarSamp) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((VarSamp) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((VarSamp) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((VarSamp) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((VarSamp) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("VAR_SAMP", ((VarSamp) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999ccfee66896381916() {
    ...
    final VarSamp actual = new VarSamp(arg0);
    ...
    Assert.assertEquals("VAR_SAMP", actual.getFunctionName());
