...
public class NameConstTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999453402ef89094625() {
    ...
    final NameConst thisObj = new NameConst(arrayList);
    ...
    Assert.assertNotNull(((NameConst) actual).getArguments());
    Assert.assertEquals(1, ((NameConst) actual).getArguments().size());
    Assert.assertNotNull(((NameConst) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((NameConst) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((NameConst) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((NameConst) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((NameConst) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((NameConst) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((NameConst) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((NameConst) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((NameConst) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((NameConst) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("NAME_CONST", ((NameConst) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999a23f24b14119ce02() {
    ...
    final NameConst actual = new NameConst(arg0);
    ...
    Assert.assertEquals("NAME_CONST", actual.getFunctionName());
