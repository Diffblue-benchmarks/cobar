...
public class GetLockTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9990ca369296f6be37d() {
    ...
    final GetLock thisObj = new GetLock(arrayList);
    ...
    Assert.assertNotNull(((GetLock) actual).getArguments());
    Assert.assertEquals(1, ((GetLock) actual).getArguments().size());
    Assert.assertNotNull(((GetLock) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((GetLock) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((GetLock) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((GetLock) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((GetLock) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((GetLock) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((GetLock) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((GetLock) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((GetLock) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((GetLock) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("GET_LOCK", ((GetLock) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99938380da65fb90346() {
    ...
    final GetLock actual = new GetLock(arg0);
    ...
    Assert.assertEquals("GET_LOCK", actual.getFunctionName());
