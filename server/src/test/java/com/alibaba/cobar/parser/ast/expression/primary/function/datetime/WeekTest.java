...
public class WeekTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9999fe789046c365f21() {
    ...
    final Week thisObj = new Week(arrayList);
    ...
    Assert.assertNotNull(((Week) actual).getArguments());
    Assert.assertEquals(1, ((Week) actual).getArguments().size());
    Assert.assertNotNull(((Week) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Week) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Week) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Week) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Week) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Week) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Week) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Week) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Week) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Week) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("WEEK", ((Week) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99900020fe2323a3fcf() {
    ...
    final Week actual = new Week(arg0);
    ...
    Assert.assertEquals("WEEK", actual.getFunctionName());
