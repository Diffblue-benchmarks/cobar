...
public class UuidShortTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9995316e6dc716368ae() {
    ...
    final UuidShort thisObj = new UuidShort(arrayList);
    ...
    Assert.assertNotNull(((UuidShort) actual).getArguments());
    Assert.assertEquals(1, ((UuidShort) actual).getArguments().size());
    Assert.assertNotNull(((UuidShort) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((UuidShort) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((UuidShort) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((UuidShort) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UuidShort) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UuidShort) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UuidShort) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UuidShort) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((UuidShort) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((UuidShort) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("UUID_SHORT", ((UuidShort) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999180574c60ff6091e() {
    ...
    final UuidShort actual = new UuidShort(arg0);
    ...
    Assert.assertEquals("UUID_SHORT", actual.getFunctionName());
