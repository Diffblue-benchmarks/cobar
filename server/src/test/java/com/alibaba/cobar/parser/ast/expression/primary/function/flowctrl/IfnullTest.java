...
public class IfnullTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999d1350ad08eb0c29f() {
    ...
    final Ifnull thisObj = new Ifnull(arrayList);
    ...
    Assert.assertNotNull(((Ifnull) actual).getArguments());
    Assert.assertEquals(1, ((Ifnull) actual).getArguments().size());
    Assert.assertNotNull(((Ifnull) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Ifnull) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Ifnull) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Ifnull) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ifnull) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ifnull) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ifnull) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ifnull) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Ifnull) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Ifnull) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("IFNULL", ((Ifnull) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9991be8aaf501b7f41c() {
    ...
    final Ifnull actual = new Ifnull(arg0);
    ...
    Assert.assertEquals("IFNULL", actual.getFunctionName());
