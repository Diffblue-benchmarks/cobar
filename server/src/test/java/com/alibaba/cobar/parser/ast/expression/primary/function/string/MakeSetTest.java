...
public class MakeSetTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999bff3f5e6aa63bc55() {
    ...
    final MakeSet thisObj = new MakeSet(arrayList);
    ...
    Assert.assertNotNull(((MakeSet) actual).getArguments());
    Assert.assertEquals(1, ((MakeSet) actual).getArguments().size());
    Assert.assertNotNull(((MakeSet) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((MakeSet) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((MakeSet) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((MakeSet) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((MakeSet) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((MakeSet) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((MakeSet) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((MakeSet) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((MakeSet) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((MakeSet) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("MAKE_SET", ((MakeSet) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999d4efacd21d1ab53a() {
    ...
    final MakeSet actual = new MakeSet(arg0);
    ...
    Assert.assertEquals("MAKE_SET", actual.getFunctionName());
