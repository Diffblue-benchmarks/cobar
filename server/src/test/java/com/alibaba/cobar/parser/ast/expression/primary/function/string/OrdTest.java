...
public class OrdTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999932b77a251ddd1b0() {
    ...
    final Ord thisObj = new Ord(arrayList);
    ...
    Assert.assertNotNull(((Ord) actual).getArguments());
    Assert.assertEquals(1, ((Ord) actual).getArguments().size());
    Assert.assertNotNull(((Ord) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Ord) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Ord) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Ord) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ord) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ord) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ord) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ord) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Ord) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Ord) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("ORD", ((Ord) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999909092560e9d95e1() {
    ...
    Assert.assertEquals("ORD", actual.getFunctionName());
