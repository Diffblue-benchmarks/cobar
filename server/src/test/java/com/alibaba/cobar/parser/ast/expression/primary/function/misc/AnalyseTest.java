...
public class AnalyseTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999af0cd3d6dc912bd4() {
    ...
    final Analyse thisObj = new Analyse(arrayList);
    ...
    Assert.assertNotNull(((Analyse) actual).getArguments());
    Assert.assertEquals(1, ((Analyse) actual).getArguments().size());
    Assert.assertNotNull(((Analyse) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Analyse) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Analyse) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Analyse) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Analyse) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Analyse) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Analyse) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Analyse) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Analyse) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Analyse) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("ANALYSE", ((Analyse) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999ae4aabd0d8d0cf01() {
    ...
    final Analyse actual = new Analyse(arg0);
    ...
    Assert.assertEquals("ANALYSE", actual.getFunctionName());
