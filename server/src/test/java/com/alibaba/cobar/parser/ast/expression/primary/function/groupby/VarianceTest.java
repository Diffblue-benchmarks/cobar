...
public class VarianceTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999a9339dbc2b8aebed() {
    ...
    final Variance thisObj = new Variance(arrayList);
    ...
    Assert.assertNotNull(((Variance) actual).getArguments());
    Assert.assertEquals(1, ((Variance) actual).getArguments().size());
    Assert.assertNotNull(((Variance) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Variance) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Variance) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Variance) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Variance) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Variance) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Variance) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Variance) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Variance) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Variance) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("VARIANCE", ((Variance) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9993788c475e73db373() {
    ...
    final Variance actual = new Variance(arg0);
    ...
    Assert.assertEquals("VARIANCE", actual.getFunctionName());
