...
public class DayofyearTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9999e610ff325432507() {
    ...
    final Dayofyear thisObj = new Dayofyear(arrayList);
    ...
    Assert.assertNotNull(((Dayofyear) actual).getArguments());
    Assert.assertEquals(1, ((Dayofyear) actual).getArguments().size());
    Assert.assertNotNull(((Dayofyear) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Dayofyear) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Dayofyear) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Dayofyear) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofyear) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofyear) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofyear) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofyear) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Dayofyear) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Dayofyear) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DAYOFYEAR", ((Dayofyear) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999da3da53efb13f953() {
    ...
    final Dayofyear actual = new Dayofyear(arg0);
    ...
    Assert.assertEquals("DAYOFYEAR", actual.getFunctionName());
