...
public class AddtimeTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9994035d51290d00b55() {
    ...
    final Addtime thisObj = new Addtime(arrayList);
    ...
    Assert.assertNotNull(((Addtime) actual).getArguments());
    Assert.assertEquals(1, ((Addtime) actual).getArguments().size());
    Assert.assertNotNull(((Addtime) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Addtime) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Addtime) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Addtime) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Addtime) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Addtime) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Addtime) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Addtime) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Addtime) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Addtime) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("ADDTIME", ((Addtime) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999e51d0f6fd1679dd9() {
    ...
    final Addtime actual = new Addtime(arg0);
    ...
    Assert.assertEquals("ADDTIME", actual.getFunctionName());
