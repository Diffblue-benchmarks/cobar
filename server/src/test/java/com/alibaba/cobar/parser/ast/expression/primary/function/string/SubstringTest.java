...
public class SubstringTest {
  ...
  @Test
  public void acceptInputNotNullOutputVoid999c0bb17057e272fcf() {
    ...
    final Substring thisObj = new Substring(arrayList);
  ...
  // Test written by Diffblue Cover
  @Test
  public void constructFunctionInputNotNullOutputNotNull99953e458e43a8aee06() {
    ...
    Assert.assertNotNull(((Substring) actual).getArguments());
    Assert.assertEquals(1, ((Substring) actual).getArguments().size());
    Assert.assertNotNull(((Substring) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Substring) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Substring) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Substring) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Substring) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Substring) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Substring) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Substring) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Substring) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Substring) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("SUBSTRING", ((Substring) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9995a681242ce4ce2de() {
    ...
    final Substring actual = new Substring(arg0);
    ...
    Assert.assertEquals("SUBSTRING", actual.getFunctionName());
