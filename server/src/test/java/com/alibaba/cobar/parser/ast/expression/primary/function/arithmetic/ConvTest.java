...
public class ConvTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999f799734e80ed3d40() {
    ...
    final Conv thisObj = new Conv(arrayList);
    ...
    Assert.assertNotNull(((Conv) actual).getArguments());
    Assert.assertEquals(1, ((Conv) actual).getArguments().size());
    Assert.assertNotNull(((Conv) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Conv) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Conv) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Conv) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Conv) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Conv) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Conv) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Conv) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Conv) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Conv) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("CONV", ((Conv) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9990c475e5d4ecbc0f9() {
    ...
    final Conv actual = new Conv(arg0);
    ...
    Assert.assertEquals("CONV", actual.getFunctionName());
