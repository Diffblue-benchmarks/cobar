...
public class VersionTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9991ef43b2e73ab6f04() {
    ...
    final Version thisObj = new Version(arrayList);
    ...
    Assert.assertNotNull(((Version) actual).getArguments());
    Assert.assertEquals(1, ((Version) actual).getArguments().size());
    Assert.assertNotNull(((Version) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Version) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Version) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Version) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Version) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Version) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Version) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Version) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Version) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Version) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("VERSION", ((Version) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9994d4b7e4d3bad2c30() {
    ...
    final Version actual = new Version(arg0);
    ...
    Assert.assertEquals("VERSION", actual.getFunctionName());
