...
public class CoercibilityTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9996abb4167f5c1fe72() {
    ...
    final Coercibility thisObj = new Coercibility(arrayList);
    ...
    Assert.assertNotNull(((Coercibility) actual).getArguments());
    Assert.assertEquals(1, ((Coercibility) actual).getArguments().size());
    Assert.assertNotNull(((Coercibility) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Coercibility) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Coercibility) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Coercibility) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Coercibility) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Coercibility) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Coercibility) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Coercibility) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Coercibility) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Coercibility) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("COERCIBILITY", ((Coercibility) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999676d24e500090ed5() {
    ...
    final Coercibility actual = new Coercibility(arg0);
    ...
    Assert.assertEquals("COERCIBILITY", actual.getFunctionName());
