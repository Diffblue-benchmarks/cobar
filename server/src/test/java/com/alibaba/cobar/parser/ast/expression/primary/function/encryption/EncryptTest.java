...
public class EncryptTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9993a1a54749d6fde14() {
    ...
    final Encrypt thisObj = new Encrypt(arrayList);
    ...
    Assert.assertNotNull(((Encrypt) actual).getArguments());
    Assert.assertEquals(1, ((Encrypt) actual).getArguments().size());
    Assert.assertNotNull(((Encrypt) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Encrypt) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Encrypt) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Encrypt) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Encrypt) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Encrypt) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Encrypt) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Encrypt) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Encrypt) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Encrypt) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("ENCRYPT", ((Encrypt) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999bab26f712ff0a92f() {
    ...
    final Encrypt actual = new Encrypt(arg0);
    ...
    Assert.assertEquals("ENCRYPT", actual.getFunctionName());
