...
public class ExportSetTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99987e37805c738421e() {
    ...
    final ExportSet thisObj = new ExportSet(arrayList);
    ...
    Assert.assertNotNull(((ExportSet) actual).getArguments());
    Assert.assertEquals(1, ((ExportSet) actual).getArguments().size());
    Assert.assertNotNull(((ExportSet) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((ExportSet) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ExportSet) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((ExportSet) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ExportSet) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ExportSet) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ExportSet) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ExportSet) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((ExportSet) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((ExportSet) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("EXPORT_SET", ((ExportSet) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9996f39892b8d6c2fe2() {
    ...
    final ExportSet actual = new ExportSet(arg0);
    ...
    Assert.assertEquals("EXPORT_SET", actual.getFunctionName());
