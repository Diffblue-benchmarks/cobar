...
public class TruncateTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99909e1664e0c0ba724() {
    ...
    final Truncate thisObj = new Truncate(arrayList);
    ...
    Assert.assertNotNull(((Truncate) actual).getArguments());
    Assert.assertEquals(1, ((Truncate) actual).getArguments().size());
    Assert.assertNotNull(((Truncate) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Truncate) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Truncate) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Truncate) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Truncate) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Truncate) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Truncate) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Truncate) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Truncate) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Truncate) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("TRUNCATE", ((Truncate) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9997daa1712a0cd4ee0() {
    ...
    final Truncate actual = new Truncate(arg0);
    ...
    Assert.assertEquals("TRUNCATE", actual.getFunctionName());
