...
public class MicrosecondTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9995339b32e213bae2c() {
    ...
    final Microsecond thisObj = new Microsecond(arrayList);
    ...
    Assert.assertNotNull(((Microsecond) actual).getArguments());
    Assert.assertEquals(1, ((Microsecond) actual).getArguments().size());
    Assert.assertNotNull(((Microsecond) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Microsecond) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Microsecond) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Microsecond) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Microsecond) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Microsecond) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Microsecond) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Microsecond) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Microsecond) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Microsecond) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("MICROSECOND", ((Microsecond) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9990fd5806537f0deac() {
    ...
    final Microsecond actual = new Microsecond(arg0);
    ...
    Assert.assertEquals("MICROSECOND", actual.getFunctionName());
