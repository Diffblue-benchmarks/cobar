...
public class DateSubTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99931c833fded54ce86() {
    ...
    final DateSub thisObj = new DateSub(arrayList);
    ...
    Assert.assertNotNull(((DateSub) actual).getArguments());
    Assert.assertEquals(1, ((DateSub) actual).getArguments().size());
    Assert.assertNotNull(((DateSub) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((DateSub) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((DateSub) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((DateSub) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DateSub) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DateSub) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DateSub) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DateSub) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((DateSub) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((DateSub) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DATE_SUB", ((DateSub) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9990b3a11940ff66528() {
    ...
    final DateSub actual = new DateSub(arg0);
    ...
    Assert.assertEquals("DATE_SUB", actual.getFunctionName());
