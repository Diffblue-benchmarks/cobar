...
public class RtrimTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999c5d6472184349a79() {
    ...
    final Rtrim thisObj = new Rtrim(arrayList);
    ...
    Assert.assertNotNull(((Rtrim) actual).getArguments());
    Assert.assertEquals(1, ((Rtrim) actual).getArguments().size());
    Assert.assertNotNull(((Rtrim) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Rtrim) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Rtrim) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Rtrim) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rtrim) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rtrim) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rtrim) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rtrim) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Rtrim) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Rtrim) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("RTRIM", ((Rtrim) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99976323f41c6bdc836() {
    ...
    final Rtrim actual = new Rtrim(arg0);
    ...
    Assert.assertEquals("RTRIM", actual.getFunctionName());
