...
public class UpdatexmlTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999a1c53657b7db12aa() {
    ...
    final Updatexml thisObj = new Updatexml(arrayList);
    ...
    Assert.assertNotNull(((Updatexml) actual).getArguments());
    Assert.assertEquals(1, ((Updatexml) actual).getArguments().size());
    Assert.assertNotNull(((Updatexml) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Updatexml) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Updatexml) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Updatexml) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Updatexml) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Updatexml) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Updatexml) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Updatexml) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Updatexml) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Updatexml) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("UPDATEXML", ((Updatexml) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999baa4d50f676f9172() {
    ...
    final Updatexml actual = new Updatexml(arg0);
    ...
    Assert.assertEquals("UPDATEXML", actual.getFunctionName());
