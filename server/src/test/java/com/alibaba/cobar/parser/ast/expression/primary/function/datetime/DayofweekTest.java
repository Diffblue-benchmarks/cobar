...
public class DayofweekTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9990d9bfd270dd06b00() {
    ...
    final Dayofweek thisObj = new Dayofweek(arrayList);
    ...
    Assert.assertNotNull(((Dayofweek) actual).getArguments());
    Assert.assertEquals(1, ((Dayofweek) actual).getArguments().size());
    Assert.assertNotNull(((Dayofweek) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Dayofweek) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Dayofweek) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Dayofweek) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofweek) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofweek) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofweek) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayofweek) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Dayofweek) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Dayofweek) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DAYOFWEEK", ((Dayofweek) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999e0dd6782e1da0155() {
    ...
    final Dayofweek actual = new Dayofweek(arg0);
    ...
    Assert.assertEquals("DAYOFWEEK", actual.getFunctionName());
