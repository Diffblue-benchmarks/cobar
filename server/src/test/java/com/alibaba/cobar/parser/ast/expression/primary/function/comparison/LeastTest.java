...
public class LeastTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99935f99e49c5c9b043() {
    ...
    final Least thisObj = new Least(arrayList);
    ...
    Assert.assertNotNull(((Least) actual).getArguments());
    Assert.assertEquals(1, ((Least) actual).getArguments().size());
    Assert.assertNotNull(((Least) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Least) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Least) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Least) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Least) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Least) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Least) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Least) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Least) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Least) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("LEAST", ((Least) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999ed18e4773feda90a() {
    ...
    final Least actual = new Least(arg0);
    ...
    Assert.assertEquals("LEAST", actual.getFunctionName());
