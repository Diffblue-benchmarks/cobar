...
public class GreatestTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999a857336a6b818dc3() {
    ...
    final Greatest thisObj = new Greatest(arrayList);
    ...
    Assert.assertNotNull(((Greatest) actual).getArguments());
    Assert.assertEquals(1, ((Greatest) actual).getArguments().size());
    Assert.assertNotNull(((Greatest) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Greatest) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Greatest) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Greatest) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Greatest) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Greatest) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Greatest) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Greatest) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Greatest) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Greatest) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("GREATEST", ((Greatest) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999f12166bf4989575b() {
    ...
    final Greatest actual = new Greatest(arg0);
    ...
    Assert.assertEquals("GREATEST", actual.getFunctionName());
