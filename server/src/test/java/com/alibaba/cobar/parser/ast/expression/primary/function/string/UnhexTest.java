...
public class UnhexTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9998dfe0164d56f8ed2() {
    ...
    final Unhex thisObj = new Unhex(arrayList);
    ...
    Assert.assertNotNull(((Unhex) actual).getArguments());
    Assert.assertEquals(1, ((Unhex) actual).getArguments().size());
    Assert.assertNotNull(((Unhex) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Unhex) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Unhex) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Unhex) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Unhex) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Unhex) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Unhex) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Unhex) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Unhex) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Unhex) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("UNHEX", ((Unhex) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9992d86c16ae5a4bb50() {
    ...
    final Unhex actual = new Unhex(arg0);
    ...
    Assert.assertEquals("UNHEX", actual.getFunctionName());
