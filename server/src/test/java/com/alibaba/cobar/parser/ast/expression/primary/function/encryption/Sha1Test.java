...
public class Sha1Test {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999e2f92429f7ef7e9b() {
    ...
    final Sha1 thisObj = new Sha1(arrayList);
    ...
    Assert.assertNotNull(((Sha1) actual).getArguments());
    Assert.assertEquals(1, ((Sha1) actual).getArguments().size());
    Assert.assertNotNull(((Sha1) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Sha1) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Sha1) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Sha1) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sha1) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sha1) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sha1) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sha1) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Sha1) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Sha1) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("SHA1", ((Sha1) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999241616b07cd3feb6() {
    ...
    final Sha1 actual = new Sha1(arg0);
    ...
    Assert.assertEquals("SHA1", actual.getFunctionName());
