...
public class HourTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9995315c1717c1826dd() {
    ...
    final Hour thisObj = new Hour(arrayList);
    ...
    Assert.assertNotNull(((Hour) actual).getArguments());
    Assert.assertEquals(1, ((Hour) actual).getArguments().size());
    Assert.assertNotNull(((Hour) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Hour) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Hour) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Hour) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Hour) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Hour) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Hour) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Hour) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Hour) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Hour) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("HOUR", ((Hour) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9991eb2126dd97b05fe() {
    ...
    final Hour actual = new Hour(arg0);
    ...
    Assert.assertEquals("HOUR", actual.getFunctionName());
