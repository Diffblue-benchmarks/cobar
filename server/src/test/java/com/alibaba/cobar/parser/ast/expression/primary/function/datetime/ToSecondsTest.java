...
public class ToSecondsTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99966610c9a4156211c() {
    ...
    final ToSeconds thisObj = new ToSeconds(arrayList);
    ...
    Assert.assertNotNull(((ToSeconds) actual).getArguments());
    Assert.assertEquals(1, ((ToSeconds) actual).getArguments().size());
    Assert.assertNotNull(((ToSeconds) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((ToSeconds) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ToSeconds) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((ToSeconds) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ToSeconds) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ToSeconds) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ToSeconds) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ToSeconds) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((ToSeconds) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((ToSeconds) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("TO_SECONDS", ((ToSeconds) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9997b917fbb3d0c3424() {
    ...
    final ToSeconds actual = new ToSeconds(arg0);
    ...
    Assert.assertEquals("TO_SECONDS", actual.getFunctionName());
