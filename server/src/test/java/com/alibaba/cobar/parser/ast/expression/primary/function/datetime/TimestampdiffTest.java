...
public class TimestampdiffTest {
  ...
  @Test
  public void acceptInputNotNullOutputVoid999ca79810186ae7bb7() {
    ...
    final Timestampdiff thisObj = new Timestampdiff(Unit.MICROSECOND, arrayList);
  ...
  // Test written by Diffblue Cover
  @Test
  public void constructFunctionInputNotNullOutputUnsupportedOperationException9991b5c3241999bb909() {
  ...
  // Test written by Diffblue Cover
  @Test
  public void constructorInputMicrosecondNotNullOutputNotNull999185522b6b136f48b() {
    ...
    final Timestampdiff actual = new Timestampdiff(arg0, arg1);
    ...
    Assert.assertEquals("TIMESTAMPDIFF", actual.getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void getUnitOutputMicrosecond999f21922fe64746368() {
