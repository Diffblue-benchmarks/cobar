...
public class InstrTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9996669f80097aba589() {
    ...
    final Instr thisObj = new Instr(arrayList);
    ...
    Assert.assertNotNull(((Instr) actual).getArguments());
    Assert.assertEquals(1, ((Instr) actual).getArguments().size());
    Assert.assertNotNull(((Instr) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Instr) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Instr) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Instr) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Instr) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Instr) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Instr) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Instr) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Instr) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Instr) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("INSTR", ((Instr) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9991a559aefcefb04e5() {
    ...
    final Instr actual = new Instr(arg0);
    ...
    Assert.assertEquals("INSTR", actual.getFunctionName());
