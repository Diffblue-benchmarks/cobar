...
public class TimeTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99944691e868feb2bed() {
    ...
    final Time thisObj = new Time(arrayList);
    ...
    Assert.assertNotNull(((Time) actual).getArguments());
    Assert.assertEquals(1, ((Time) actual).getArguments().size());
    Assert.assertNotNull(((Time) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Time) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Time) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Time) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Time) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Time) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Time) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Time) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Time) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Time) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("TIME", ((Time) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99993336bdfc9f7934a() {
    ...
    final Time actual = new Time(arg0);
    ...
    Assert.assertEquals("TIME", actual.getFunctionName());
