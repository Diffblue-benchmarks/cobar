...
public class ReverseTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999138b6e0ecdf33b78() {
    ...
    final Reverse thisObj = new Reverse(arrayList);
    ...
    Assert.assertNotNull(((Reverse) actual).getArguments());
    Assert.assertEquals(1, ((Reverse) actual).getArguments().size());
    Assert.assertNotNull(((Reverse) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Reverse) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Reverse) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Reverse) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Reverse) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Reverse) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Reverse) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Reverse) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Reverse) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Reverse) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("REVERSE", ((Reverse) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9993cc19c1a287a54ae() {
    ...
    final Reverse actual = new Reverse(arg0);
    ...
    Assert.assertEquals("REVERSE", actual.getFunctionName());
