...
public class DateTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999fbaaf2ae9cbc4559() {
    ...
    final Date thisObj = new Date(arrayList);
    ...
    Assert.assertNotNull(((Date) actual).getArguments());
    Assert.assertEquals(1, ((Date) actual).getArguments().size());
    Assert.assertNotNull(((Date) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Date) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Date) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Date) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Date) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Date) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Date) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Date) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Date) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Date) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DATE", ((Date) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999b9690c48bd03933e() {
    ...
    final Date actual = new Date(arg0);
    ...
    Assert.assertEquals("DATE", actual.getFunctionName());
