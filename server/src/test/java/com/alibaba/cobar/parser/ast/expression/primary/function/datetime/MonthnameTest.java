...
public class MonthnameTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9992cabdffc17dd105c() {
    ...
    final Monthname thisObj = new Monthname(arrayList);
    ...
    Assert.assertNotNull(((Monthname) actual).getArguments());
    Assert.assertEquals(1, ((Monthname) actual).getArguments().size());
    Assert.assertNotNull(((Monthname) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Monthname) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Monthname) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Monthname) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Monthname) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Monthname) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Monthname) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Monthname) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Monthname) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Monthname) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("MONTHNAME", ((Monthname) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999bd28e5d45cf56f8b() {
    ...
    final Monthname actual = new Monthname(arg0);
    ...
    Assert.assertEquals("MONTHNAME", actual.getFunctionName());
