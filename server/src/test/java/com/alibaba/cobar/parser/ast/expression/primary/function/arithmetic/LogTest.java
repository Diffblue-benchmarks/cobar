...
public class LogTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999d92601d767e9ac31() {
    ...
    final Log thisObj = new Log(arrayList);
    ...
    Assert.assertNotNull(((Log) actual).getArguments());
    Assert.assertEquals(1, ((Log) actual).getArguments().size());
    Assert.assertNotNull(((Log) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Log) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Log) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Log) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Log) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Log) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Log) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Log) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Log) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Log) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("LOG", ((Log) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99968f34f5d62caa21a() {
    ...
    Assert.assertEquals("LOG", actual.getFunctionName());
