...
public class YearTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999650ef7780ffdfa69() {
    ...
    final Year thisObj = new Year(arrayList);
    ...
    Assert.assertNotNull(((Year) actual).getArguments());
    Assert.assertEquals(1, ((Year) actual).getArguments().size());
    Assert.assertNotNull(((Year) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Year) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Year) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Year) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Year) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Year) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Year) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Year) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Year) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Year) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("YEAR", ((Year) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999a20082181089e763() {
    ...
    final Year actual = new Year(arg0);
    ...
    Assert.assertEquals("YEAR", actual.getFunctionName());
