...
public class StddevPopTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9999d1d3ec9b25e2dd5() {
    ...
    final StddevPop thisObj = new StddevPop(arrayList);
    ...
    Assert.assertNotNull(((StddevPop) actual).getArguments());
    Assert.assertEquals(1, ((StddevPop) actual).getArguments().size());
    Assert.assertNotNull(((StddevPop) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((StddevPop) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((StddevPop) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((StddevPop) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((StddevPop) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((StddevPop) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((StddevPop) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((StddevPop) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((StddevPop) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((StddevPop) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("STDDEV_POP", ((StddevPop) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999786ff8941836234c() {
    ...
    final StddevPop actual = new StddevPop(arg0);
    ...
    Assert.assertEquals("STDDEV_POP", actual.getFunctionName());
