...
public class MonthTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9992feb4dd7581910ba() {
    ...
    final Month thisObj = new Month(arrayList);
    ...
    Assert.assertNotNull(((Month) actual).getArguments());
    Assert.assertEquals(1, ((Month) actual).getArguments().size());
    Assert.assertNotNull(((Month) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Month) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Month) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Month) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Month) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Month) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Month) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Month) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Month) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Month) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("MONTH", ((Month) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999e8af4d903962de85() {
    ...
    final Month actual = new Month(arg0);
    ...
    Assert.assertEquals("MONTH", actual.getFunctionName());
