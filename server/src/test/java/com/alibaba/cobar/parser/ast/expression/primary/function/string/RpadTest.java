...
public class RpadTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9993d9c8eab163f831a() {
    ...
    final Rpad thisObj = new Rpad(arrayList);
    ...
    Assert.assertNotNull(((Rpad) actual).getArguments());
    Assert.assertEquals(1, ((Rpad) actual).getArguments().size());
    Assert.assertNotNull(((Rpad) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Rpad) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Rpad) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Rpad) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rpad) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rpad) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rpad) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rpad) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Rpad) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Rpad) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("RPAD", ((Rpad) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99952e22e6cacd06f30() {
    ...
    final Rpad actual = new Rpad(arg0);
    ...
    Assert.assertEquals("RPAD", actual.getFunctionName());
