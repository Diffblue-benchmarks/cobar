...
public class UtcDateTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999a75b9099dfc859b2() {
    ...
    final UtcDate thisObj = new UtcDate(arrayList);
    ...
    Assert.assertNotNull(((UtcDate) actual).getArguments());
    Assert.assertEquals(1, ((UtcDate) actual).getArguments().size());
    Assert.assertNotNull(((UtcDate) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((UtcDate) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((UtcDate) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((UtcDate) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UtcDate) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UtcDate) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UtcDate) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UtcDate) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((UtcDate) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((UtcDate) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("UTC_DATE", ((UtcDate) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99966697c7fc98b47ac() {
    ...
    final UtcDate actual = new UtcDate(arg0);
    ...
    Assert.assertEquals("UTC_DATE", actual.getFunctionName());
