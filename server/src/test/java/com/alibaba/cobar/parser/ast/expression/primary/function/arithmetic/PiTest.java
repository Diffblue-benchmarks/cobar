...
public class PiTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99923a3c88f425c95d8() {
    ...
    final Pi thisObj = new Pi(arrayList);
    ...
    Assert.assertNotNull(((Pi) actual).getArguments());
    Assert.assertEquals(1, ((Pi) actual).getArguments().size());
    Assert.assertNotNull(((Pi) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Pi) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Pi) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Pi) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Pi) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Pi) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Pi) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Pi) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Pi) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Pi) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("PI", ((Pi) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9997f4efe626ca8afdb() {
    ...
    Assert.assertEquals("PI", actual.getFunctionName());
