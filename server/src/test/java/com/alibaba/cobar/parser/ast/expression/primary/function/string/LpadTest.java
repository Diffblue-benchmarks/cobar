...
public class LpadTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9996e1be54dc553fac3() {
    ...
    final Lpad thisObj = new Lpad(arrayList);
    ...
    Assert.assertNotNull(((Lpad) actual).getArguments());
    Assert.assertEquals(1, ((Lpad) actual).getArguments().size());
    Assert.assertNotNull(((Lpad) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Lpad) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Lpad) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Lpad) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Lpad) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Lpad) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Lpad) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Lpad) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Lpad) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Lpad) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("LPAD", ((Lpad) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999cf38e33e5c2fb6ec() {
    ...
    final Lpad actual = new Lpad(arg0);
    ...
    Assert.assertEquals("LPAD", actual.getFunctionName());
