...
public class Atan2Test {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9997bff6c2d987d02b4() {
    ...
    final Atan2 thisObj = new Atan2(arrayList);
    ...
    Assert.assertNotNull(((Atan2) actual).getArguments());
    Assert.assertEquals(1, ((Atan2) actual).getArguments().size());
    Assert.assertNotNull(((Atan2) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Atan2) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Atan2) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Atan2) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Atan2) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Atan2) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Atan2) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Atan2) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Atan2) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Atan2) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("ATAN2", ((Atan2) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999d835cead2035fa09() {
    ...
    final Atan2 actual = new Atan2(arg0);
    ...
    Assert.assertEquals("ATAN2", actual.getFunctionName());
