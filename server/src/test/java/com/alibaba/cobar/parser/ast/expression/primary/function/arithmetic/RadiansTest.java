...
public class RadiansTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999a5e8e77a1a983054() {
    ...
    final Radians thisObj = new Radians(arrayList);
    ...
    Assert.assertNotNull(((Radians) actual).getArguments());
    Assert.assertEquals(1, ((Radians) actual).getArguments().size());
    Assert.assertNotNull(((Radians) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Radians) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Radians) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Radians) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Radians) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Radians) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Radians) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Radians) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Radians) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Radians) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("RADIANS", ((Radians) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9992ea8e103e5f7af06() {
    ...
    final Radians actual = new Radians(arg0);
    ...
    Assert.assertEquals("RADIANS", actual.getFunctionName());
