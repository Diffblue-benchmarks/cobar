...
public class SecToTimeTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999eea2cf3208f3e65d() {
    ...
    final SecToTime thisObj = new SecToTime(arrayList);
    ...
    Assert.assertNotNull(((SecToTime) actual).getArguments());
    Assert.assertEquals(1, ((SecToTime) actual).getArguments().size());
    Assert.assertNotNull(((SecToTime) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((SecToTime) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((SecToTime) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((SecToTime) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((SecToTime) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((SecToTime) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((SecToTime) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((SecToTime) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((SecToTime) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((SecToTime) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("SEC_TO_TIME", ((SecToTime) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999ab9cd47bcac737af() {
    ...
    final SecToTime actual = new SecToTime(arg0);
    ...
    Assert.assertEquals("SEC_TO_TIME", actual.getFunctionName());
