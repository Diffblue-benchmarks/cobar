...
public class FindInSetTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9997e85cca8399ef442() {
    ...
    final FindInSet thisObj = new FindInSet(arrayList);
    ...
    Assert.assertNotNull(((FindInSet) actual).getArguments());
    Assert.assertEquals(1, ((FindInSet) actual).getArguments().size());
    Assert.assertNotNull(((FindInSet) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((FindInSet) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((FindInSet) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((FindInSet) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FindInSet) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FindInSet) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FindInSet) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FindInSet) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((FindInSet) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((FindInSet) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("FIND_IN_SET", ((FindInSet) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999d4f25bc309d1479c() {
    ...
    final FindInSet actual = new FindInSet(arg0);
    ...
    Assert.assertEquals("FIND_IN_SET", actual.getFunctionName());
