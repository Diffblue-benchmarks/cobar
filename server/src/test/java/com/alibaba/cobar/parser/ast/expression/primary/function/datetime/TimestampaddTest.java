...
public class TimestampaddTest {
  ...
  @Test
  public void acceptInputNotNullOutputVoid999387b0313e924f658() {
    ...
    final Timestampadd thisObj = new Timestampadd(Unit.MICROSECOND, arrayList);
  ...
  // Test written by Diffblue Cover
  @Test
  public void constructFunctionInputNotNullOutputUnsupportedOperationException9990b8b3b86dab0c98a() {
  ...
  // Test written by Diffblue Cover
  @Test
  public void constructorInputMicrosecondNotNullOutputNotNull999a9b56941c9736149() {
    ...
    final Timestampadd actual = new Timestampadd(arg0, arg1);
    ...
    Assert.assertEquals("TIMESTAMPADD", actual.getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void getUnitOutputMicrosecond999ad0cae00700dee4b() {
