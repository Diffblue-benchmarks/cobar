...
public class MasterPosWaitTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999b88bdccc7a1e316c() {
    ...
    final MasterPosWait thisObj = new MasterPosWait(arrayList);
    ...
    Assert.assertNotNull(((MasterPosWait) actual).getArguments());
    Assert.assertEquals(1, ((MasterPosWait) actual).getArguments().size());
    Assert.assertNotNull(((MasterPosWait) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((MasterPosWait) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((MasterPosWait) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((MasterPosWait) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((MasterPosWait) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((MasterPosWait) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((MasterPosWait) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((MasterPosWait) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((MasterPosWait) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((MasterPosWait) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("MASTER_POS_WAIT", ((MasterPosWait) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999a0f0c25ac7b46bb4() {
    ...
    final MasterPosWait actual = new MasterPosWait(arg0);
    ...
    Assert.assertEquals("MASTER_POS_WAIT", actual.getFunctionName());
