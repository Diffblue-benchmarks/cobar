...
public class ConcatWsTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9992bf8d8b963f987c0() {
    ...
    final ConcatWs thisObj = new ConcatWs(arrayList);
    ...
    Assert.assertNotNull(((ConcatWs) actual).getArguments());
    Assert.assertEquals(1, ((ConcatWs) actual).getArguments().size());
    Assert.assertNotNull(((ConcatWs) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((ConcatWs) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ConcatWs) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((ConcatWs) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ConcatWs) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ConcatWs) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ConcatWs) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((ConcatWs) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((ConcatWs) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((ConcatWs) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("CONCAT_WS", ((ConcatWs) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9991f4c64cf73b2be23() {
    ...
    final ConcatWs actual = new ConcatWs(arg0);
    ...
    Assert.assertEquals("CONCAT_WS", actual.getFunctionName());
