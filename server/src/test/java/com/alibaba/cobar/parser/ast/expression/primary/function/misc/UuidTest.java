...
public class UuidTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9993374f988638ec758() {
    ...
    final Uuid thisObj = new Uuid(arrayList);
    ...
    Assert.assertNotNull(((Uuid) actual).getArguments());
    Assert.assertEquals(1, ((Uuid) actual).getArguments().size());
    Assert.assertNotNull(((Uuid) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Uuid) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Uuid) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Uuid) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Uuid) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Uuid) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Uuid) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Uuid) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Uuid) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Uuid) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("UUID", ((Uuid) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9998e804608d36f1c40() {
    ...
    final Uuid actual = new Uuid(arg0);
    ...
    Assert.assertEquals("UUID", actual.getFunctionName());
