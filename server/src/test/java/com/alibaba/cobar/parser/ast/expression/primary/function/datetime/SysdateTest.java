...
public class SysdateTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999dc37489f129a46de() {
    ...
    final Sysdate thisObj = new Sysdate(arrayList);
    ...
    Assert.assertNotNull(((Sysdate) actual).getArguments());
    Assert.assertEquals(1, ((Sysdate) actual).getArguments().size());
    Assert.assertNotNull(((Sysdate) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Sysdate) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Sysdate) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Sysdate) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sysdate) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sysdate) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sysdate) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sysdate) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Sysdate) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Sysdate) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("SYSDATE", ((Sysdate) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999ecf4cb79613431c3() {
    ...
    final Sysdate actual = new Sysdate(arg0);
    ...
    Assert.assertEquals("SYSDATE", actual.getFunctionName());
