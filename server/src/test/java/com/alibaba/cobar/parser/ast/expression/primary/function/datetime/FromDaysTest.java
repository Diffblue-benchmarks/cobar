...
public class FromDaysTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99947b4878514eb1a71() {
    ...
    final FromDays thisObj = new FromDays(arrayList);
    ...
    Assert.assertNotNull(((FromDays) actual).getArguments());
    Assert.assertEquals(1, ((FromDays) actual).getArguments().size());
    Assert.assertNotNull(((FromDays) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((FromDays) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((FromDays) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((FromDays) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FromDays) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FromDays) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FromDays) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((FromDays) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((FromDays) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((FromDays) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("FROM_DAYS", ((FromDays) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9991dfd6c9ea56dd6c0() {
    ...
    final FromDays actual = new FromDays(arg0);
    ...
    Assert.assertEquals("FROM_DAYS", actual.getFunctionName());
