...
public class QuoteTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999b9a32e266fc1ac36() {
    ...
    final Quote thisObj = new Quote(arrayList);
    ...
    Assert.assertNotNull(((Quote) actual).getArguments());
    Assert.assertEquals(1, ((Quote) actual).getArguments().size());
    Assert.assertNotNull(((Quote) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Quote) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Quote) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Quote) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Quote) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Quote) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Quote) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Quote) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Quote) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Quote) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("QUOTE", ((Quote) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99951eb757bb567283e() {
    ...
    final Quote actual = new Quote(arg0);
    ...
    Assert.assertEquals("QUOTE", actual.getFunctionName());
