...
public class AbsTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999df97b508b0eabf7c() {
    ...
    final Abs thisObj = new Abs(arrayList);
    ...
    Assert.assertNotNull(((Abs) actual).getArguments());
    Assert.assertEquals(1, ((Abs) actual).getArguments().size());
    Assert.assertNotNull(((Abs) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Abs) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Abs) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Abs) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Abs) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Abs) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Abs) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Abs) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Abs) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Abs) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("ABS", ((Abs) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9992c5897adb7d3ec99() {
    ...
    Assert.assertEquals("ABS", actual.getFunctionName());
