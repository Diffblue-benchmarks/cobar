...
public class LtrimTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9997d251cc50dabf3c3() {
    ...
    final Ltrim thisObj = new Ltrim(arrayList);
    ...
    Assert.assertNotNull(((Ltrim) actual).getArguments());
    Assert.assertEquals(1, ((Ltrim) actual).getArguments().size());
    Assert.assertNotNull(((Ltrim) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Ltrim) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Ltrim) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Ltrim) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ltrim) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ltrim) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ltrim) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ltrim) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Ltrim) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Ltrim) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("LTRIM", ((Ltrim) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999ef9280199dbae148() {
    ...
    final Ltrim actual = new Ltrim(arg0);
    ...
    Assert.assertEquals("LTRIM", actual.getFunctionName());
