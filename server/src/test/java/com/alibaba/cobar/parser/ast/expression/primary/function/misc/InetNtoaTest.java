...
public class InetNtoaTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99957e7293d078bd78c() {
    ...
    final InetNtoa thisObj = new InetNtoa(arrayList);
    ...
    Assert.assertNotNull(((InetNtoa) actual).getArguments());
    Assert.assertEquals(1, ((InetNtoa) actual).getArguments().size());
    Assert.assertNotNull(((InetNtoa) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((InetNtoa) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((InetNtoa) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((InetNtoa) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((InetNtoa) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((InetNtoa) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((InetNtoa) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((InetNtoa) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((InetNtoa) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((InetNtoa) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("INET_NTOA", ((InetNtoa) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999d23c26c1c0fcbfa7() {
    ...
    final InetNtoa actual = new InetNtoa(arg0);
    ...
    Assert.assertEquals("INET_NTOA", actual.getFunctionName());
