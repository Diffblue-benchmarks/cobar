...
public class PeriodDiffTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9999e9907e4b7b3ef46() {
    ...
    final PeriodDiff thisObj = new PeriodDiff(arrayList);
    ...
    Assert.assertNotNull(((PeriodDiff) actual).getArguments());
    Assert.assertEquals(1, ((PeriodDiff) actual).getArguments().size());
    Assert.assertNotNull(((PeriodDiff) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((PeriodDiff) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((PeriodDiff) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((PeriodDiff) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((PeriodDiff) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((PeriodDiff) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((PeriodDiff) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((PeriodDiff) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((PeriodDiff) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((PeriodDiff) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("PERIOD_DIFF", ((PeriodDiff) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999163ab51476778254() {
    ...
    final PeriodDiff actual = new PeriodDiff(arg0);
    ...
    Assert.assertEquals("PERIOD_DIFF", actual.getFunctionName());
