...
public class AtanTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999cdc481a2bb0887c7() {
    ...
    final Atan thisObj = new Atan(arrayList);
    ...
    Assert.assertNotNull(((Atan) actual).getArguments());
    Assert.assertEquals(1, ((Atan) actual).getArguments().size());
    Assert.assertNotNull(((Atan) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Atan) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Atan) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Atan) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Atan) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Atan) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Atan) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Atan) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Atan) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Atan) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("ATAN", ((Atan) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99996af5fcb3db184bc() {
    ...
    final Atan actual = new Atan(arg0);
    ...
    Assert.assertEquals("ATAN", actual.getFunctionName());
