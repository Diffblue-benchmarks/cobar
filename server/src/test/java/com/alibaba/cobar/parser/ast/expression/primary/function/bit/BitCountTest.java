...
public class BitCountTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99914c77430c215e30e() {
    ...
    final BitCount thisObj = new BitCount(arrayList);
    ...
    Assert.assertNotNull(((BitCount) actual).getArguments());
    Assert.assertEquals(1, ((BitCount) actual).getArguments().size());
    Assert.assertNotNull(((BitCount) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((BitCount) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((BitCount) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((BitCount) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitCount) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitCount) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitCount) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitCount) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((BitCount) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((BitCount) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("BIT_COUNT", ((BitCount) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999450fda38227ed5cb() {
    ...
    final BitCount actual = new BitCount(arg0);
    ...
    Assert.assertEquals("BIT_COUNT", actual.getFunctionName());
