...
public class RepeatTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999891586e0caa327cd() {
    ...
    final Repeat thisObj = new Repeat(arrayList);
    ...
    Assert.assertNotNull(((Repeat) actual).getArguments());
    Assert.assertEquals(1, ((Repeat) actual).getArguments().size());
    Assert.assertNotNull(((Repeat) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Repeat) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Repeat) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Repeat) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Repeat) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Repeat) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Repeat) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Repeat) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Repeat) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Repeat) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("REPEAT", ((Repeat) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99929de92d190ddc47e() {
    ...
    final Repeat actual = new Repeat(arg0);
    ...
    Assert.assertEquals("REPEAT", actual.getFunctionName());
