...
public class BitLengthTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99969bee200d72e885c() {
    ...
    final BitLength thisObj = new BitLength(arrayList);
    ...
    Assert.assertNotNull(((BitLength) actual).getArguments());
    Assert.assertEquals(1, ((BitLength) actual).getArguments().size());
    Assert.assertNotNull(((BitLength) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((BitLength) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((BitLength) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((BitLength) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitLength) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitLength) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitLength) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitLength) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((BitLength) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((BitLength) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("BIT_LENGTH", ((BitLength) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99901c5ad3c8faf714e() {
    ...
    final BitLength actual = new BitLength(arg0);
    ...
    Assert.assertEquals("BIT_LENGTH", actual.getFunctionName());
