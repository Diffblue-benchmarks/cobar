...
public class OldPasswordTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9994b5f7685d114eb0e() {
    ...
    final OldPassword thisObj = new OldPassword(arrayList);
    ...
    Assert.assertNotNull(((OldPassword) actual).getArguments());
    Assert.assertEquals(1, ((OldPassword) actual).getArguments().size());
    Assert.assertNotNull(((OldPassword) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((OldPassword) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((OldPassword) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((OldPassword) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((OldPassword) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((OldPassword) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((OldPassword) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((OldPassword) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((OldPassword) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((OldPassword) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("OLD_PASSWORD", ((OldPassword) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999cbb0118d01566550() {
    ...
    final OldPassword actual = new OldPassword(arg0);
    ...
    Assert.assertEquals("OLD_PASSWORD", actual.getFunctionName());
