...
public class UtcTimestampTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9992acd82c9847dcdea() {
    ...
    final UtcTimestamp thisObj = new UtcTimestamp(arrayList);
    ...
    Assert.assertNotNull(((UtcTimestamp) actual).getArguments());
    Assert.assertEquals(1, ((UtcTimestamp) actual).getArguments().size());
    Assert.assertNotNull(((UtcTimestamp) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((UtcTimestamp) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((UtcTimestamp) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((UtcTimestamp) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UtcTimestamp) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UtcTimestamp) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UtcTimestamp) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UtcTimestamp) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((UtcTimestamp) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((UtcTimestamp) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("UTC_TIMESTAMP", ((UtcTimestamp) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9994e30f81659506e39() {
    ...
    final UtcTimestamp actual = new UtcTimestamp(arg0);
    ...
    Assert.assertEquals("UTC_TIMESTAMP", actual.getFunctionName());
