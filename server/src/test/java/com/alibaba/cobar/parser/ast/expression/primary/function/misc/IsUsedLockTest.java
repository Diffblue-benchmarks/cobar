...
public class IsUsedLockTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999e2144a38fc56a92e() {
    ...
    final IsUsedLock thisObj = new IsUsedLock(arrayList);
    ...
    Assert.assertNotNull(((IsUsedLock) actual).getArguments());
    Assert.assertEquals(1, ((IsUsedLock) actual).getArguments().size());
    Assert.assertNotNull(((IsUsedLock) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((IsUsedLock) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((IsUsedLock) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((IsUsedLock) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((IsUsedLock) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((IsUsedLock) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((IsUsedLock) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((IsUsedLock) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((IsUsedLock) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((IsUsedLock) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("IS_USED_LOCK", ((IsUsedLock) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999d1f17abd5c37896c() {
    ...
    final IsUsedLock actual = new IsUsedLock(arg0);
    ...
    Assert.assertEquals("IS_USED_LOCK", actual.getFunctionName());
