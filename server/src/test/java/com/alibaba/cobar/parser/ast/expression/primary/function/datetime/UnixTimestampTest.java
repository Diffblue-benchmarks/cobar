...
public class UnixTimestampTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9991c99e4474b2dbfb5() {
    ...
    final UnixTimestamp thisObj = new UnixTimestamp(arrayList);
    ...
    Assert.assertNotNull(((UnixTimestamp) actual).getArguments());
    Assert.assertEquals(1, ((UnixTimestamp) actual).getArguments().size());
    Assert.assertNotNull(((UnixTimestamp) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((UnixTimestamp) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((UnixTimestamp) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((UnixTimestamp) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UnixTimestamp) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UnixTimestamp) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UnixTimestamp) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((UnixTimestamp) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((UnixTimestamp) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((UnixTimestamp) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("UNIX_TIMESTAMP", ((UnixTimestamp) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9990f3c51fba024c7ea() {
    ...
    final UnixTimestamp actual = new UnixTimestamp(arg0);
    ...
    Assert.assertEquals("UNIX_TIMESTAMP", actual.getFunctionName());
