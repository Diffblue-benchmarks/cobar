...
public class FormatTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99937beda70113e710f() {
    ...
    final Format thisObj = new Format(arrayList);
    ...
    Assert.assertNotNull(((Format) actual).getArguments());
    Assert.assertEquals(1, ((Format) actual).getArguments().size());
    Assert.assertNotNull(((Format) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Format) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Format) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Format) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Format) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Format) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Format) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Format) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Format) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Format) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("FORMAT", ((Format) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999e0f8f4cbd1e09e6c() {
    ...
    final Format actual = new Format(arg0);
    ...
    Assert.assertEquals("FORMAT", actual.getFunctionName());
