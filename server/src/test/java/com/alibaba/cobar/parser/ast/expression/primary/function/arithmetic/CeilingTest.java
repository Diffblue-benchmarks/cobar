...
public class CeilingTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999b9aa944e1a94fd7a() {
    ...
    final Ceiling thisObj = new Ceiling(arrayList);
    ...
    Assert.assertNotNull(((Ceiling) actual).getArguments());
    Assert.assertEquals(1, ((Ceiling) actual).getArguments().size());
    Assert.assertNotNull(((Ceiling) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Ceiling) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Ceiling) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Ceiling) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ceiling) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ceiling) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ceiling) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Ceiling) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Ceiling) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Ceiling) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("CEILING", ((Ceiling) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999c694099ad67110f7() {
    ...
    final Ceiling actual = new Ceiling(arg0);
    ...
    Assert.assertEquals("CEILING", actual.getFunctionName());
