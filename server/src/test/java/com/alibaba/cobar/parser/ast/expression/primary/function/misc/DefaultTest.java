...
public class DefaultTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999cb2612d23f66dcf9() {
    ...
    final Default thisObj = new Default(arrayList);
    ...
    Assert.assertNotNull(((Default) actual).getArguments());
    Assert.assertEquals(1, ((Default) actual).getArguments().size());
    Assert.assertNotNull(((Default) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Default) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Default) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Default) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Default) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Default) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Default) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Default) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Default) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Default) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DEFAULT", ((Default) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9996f327365f05cd05e() {
    ...
    final Default actual = new Default(arg0);
    ...
    Assert.assertEquals("DEFAULT", actual.getFunctionName());
