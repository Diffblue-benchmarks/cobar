...
public class InsertTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9998aba0e6ea0e7f5fb() {
    ...
    final Insert thisObj = new Insert(arrayList);
    ...
    Assert.assertNotNull(((Insert) actual).getArguments());
    Assert.assertEquals(1, ((Insert) actual).getArguments().size());
    Assert.assertNotNull(((Insert) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Insert) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Insert) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Insert) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Insert) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Insert) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Insert) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Insert) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Insert) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Insert) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("INSERT", ((Insert) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999639c2822584d2e26() {
    ...
    final Insert actual = new Insert(arg0);
    ...
    Assert.assertEquals("INSERT", actual.getFunctionName());
