...
public class DateFormatTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99910bd33a8476bfbde() {
    ...
    final DateFormat thisObj = new DateFormat(arrayList);
    ...
    Assert.assertNotNull(((DateFormat) actual).getArguments());
    Assert.assertEquals(1, ((DateFormat) actual).getArguments().size());
    Assert.assertNotNull(((DateFormat) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((DateFormat) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((DateFormat) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((DateFormat) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DateFormat) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DateFormat) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DateFormat) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((DateFormat) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((DateFormat) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((DateFormat) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DATE_FORMAT", ((DateFormat) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999cd89a96ff7e68da5() {
    ...
    final DateFormat actual = new DateFormat(arg0);
    ...
    Assert.assertEquals("DATE_FORMAT", actual.getFunctionName());
