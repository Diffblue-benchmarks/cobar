...
public class DegreesTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999a9ef3b820892bcff() {
    ...
    final Degrees thisObj = new Degrees(arrayList);
    ...
    Assert.assertNotNull(((Degrees) actual).getArguments());
    Assert.assertEquals(1, ((Degrees) actual).getArguments().size());
    Assert.assertNotNull(((Degrees) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Degrees) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Degrees) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Degrees) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Degrees) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Degrees) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Degrees) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Degrees) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Degrees) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Degrees) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DEGREES", ((Degrees) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99986bc093100a83d28() {
    ...
    final Degrees actual = new Degrees(arg0);
    ...
    Assert.assertEquals("DEGREES", actual.getFunctionName());
