...
public class StrcmpTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999271b02e0a7283237() {
    ...
    final Strcmp thisObj = new Strcmp(arrayList);
    ...
    Assert.assertNotNull(((Strcmp) actual).getArguments());
    Assert.assertEquals(1, ((Strcmp) actual).getArguments().size());
    Assert.assertNotNull(((Strcmp) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Strcmp) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Strcmp) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Strcmp) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Strcmp) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Strcmp) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Strcmp) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Strcmp) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Strcmp) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Strcmp) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("STRCMP", ((Strcmp) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9993a482455f5e57afc() {
    ...
    final Strcmp actual = new Strcmp(arg0);
    ...
    Assert.assertEquals("STRCMP", actual.getFunctionName());
