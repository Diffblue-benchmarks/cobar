...
public class QuarterTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999435b5b331bb7cd09() {
    ...
    final Quarter thisObj = new Quarter(arrayList);
    ...
    Assert.assertNotNull(((Quarter) actual).getArguments());
    Assert.assertEquals(1, ((Quarter) actual).getArguments().size());
    Assert.assertNotNull(((Quarter) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Quarter) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Quarter) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Quarter) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Quarter) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Quarter) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Quarter) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Quarter) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Quarter) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Quarter) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("QUARTER", ((Quarter) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9996e41be0efeb0ddb3() {
    ...
    final Quarter actual = new Quarter(arg0);
    ...
    Assert.assertEquals("QUARTER", actual.getFunctionName());
