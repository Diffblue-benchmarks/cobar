...
public class AesDecryptTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999bae668573b487f4d() {
    ...
    final AesDecrypt thisObj = new AesDecrypt(arrayList);
    ...
    Assert.assertNotNull(((AesDecrypt) actual).getArguments());
    Assert.assertEquals(1, ((AesDecrypt) actual).getArguments().size());
    Assert.assertNotNull(((AesDecrypt) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((AesDecrypt) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((AesDecrypt) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((AesDecrypt) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((AesDecrypt) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((AesDecrypt) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((AesDecrypt) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((AesDecrypt) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((AesDecrypt) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((AesDecrypt) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("AES_DECRYPT", ((AesDecrypt) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999240ebc5f33c159d0() {
    ...
    final AesDecrypt actual = new AesDecrypt(arg0);
    ...
    Assert.assertEquals("AES_DECRYPT", actual.getFunctionName());
