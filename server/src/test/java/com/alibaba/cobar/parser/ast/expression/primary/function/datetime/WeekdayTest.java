...
public class WeekdayTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999f2c445fd7950c8d7() {
    ...
    final Weekday thisObj = new Weekday(arrayList);
    ...
    Assert.assertNotNull(((Weekday) actual).getArguments());
    Assert.assertEquals(1, ((Weekday) actual).getArguments().size());
    Assert.assertNotNull(((Weekday) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Weekday) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Weekday) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Weekday) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Weekday) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Weekday) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Weekday) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Weekday) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Weekday) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Weekday) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("WEEKDAY", ((Weekday) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999950880dc577a612d() {
    ...
    final Weekday actual = new Weekday(arg0);
    ...
    Assert.assertEquals("WEEKDAY", actual.getFunctionName());
