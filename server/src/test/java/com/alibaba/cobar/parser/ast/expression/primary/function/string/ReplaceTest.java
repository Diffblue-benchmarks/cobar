...
public class ReplaceTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999c8b0cef6d6aae4e5() {
    ...
    final Replace thisObj = new Replace(arrayList);
    ...
    Assert.assertNotNull(((Replace) actual).getArguments());
    Assert.assertEquals(1, ((Replace) actual).getArguments().size());
    Assert.assertNotNull(((Replace) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Replace) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Replace) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Replace) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Replace) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Replace) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Replace) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Replace) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Replace) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Replace) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("REPLACE", ((Replace) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99938de1325128ef484() {
    ...
    final Replace actual = new Replace(arg0);
    ...
    Assert.assertEquals("REPLACE", actual.getFunctionName());
