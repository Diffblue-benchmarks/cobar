...
public class DecodeTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9997ef897456d427bd5() {
    ...
    final Decode thisObj = new Decode(arrayList);
    ...
    Assert.assertNotNull(((Decode) actual).getArguments());
    Assert.assertEquals(1, ((Decode) actual).getArguments().size());
    Assert.assertNotNull(((Decode) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Decode) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Decode) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Decode) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Decode) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Decode) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Decode) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Decode) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Decode) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Decode) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DECODE", ((Decode) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9997e2d17200213b890() {
    ...
    final Decode actual = new Decode(arg0);
    ...
    Assert.assertEquals("DECODE", actual.getFunctionName());
