...
public class IsnullTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9994a244a8769b44efd() {
    ...
    final Isnull thisObj = new Isnull(arrayList);
    ...
    Assert.assertNotNull(((Isnull) actual).getArguments());
    Assert.assertEquals(1, ((Isnull) actual).getArguments().size());
    Assert.assertNotNull(((Isnull) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Isnull) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Isnull) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Isnull) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Isnull) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Isnull) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Isnull) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Isnull) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Isnull) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Isnull) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("ISNULL", ((Isnull) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9999aeb9cba66979ed8() {
    ...
    final Isnull actual = new Isnull(arg0);
    ...
    Assert.assertEquals("ISNULL", actual.getFunctionName());
