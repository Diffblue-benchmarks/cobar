...
public class DatediffTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99930543fd006ef52b4() {
    ...
    final Datediff thisObj = new Datediff(arrayList);
    ...
    Assert.assertNotNull(((Datediff) actual).getArguments());
    Assert.assertEquals(1, ((Datediff) actual).getArguments().size());
    Assert.assertNotNull(((Datediff) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Datediff) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Datediff) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Datediff) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Datediff) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Datediff) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Datediff) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Datediff) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Datediff) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Datediff) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DATEDIFF", ((Datediff) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9996b00f2cbbe22328c() {
    ...
    final Datediff actual = new Datediff(arg0);
    ...
    Assert.assertEquals("DATEDIFF", actual.getFunctionName());
