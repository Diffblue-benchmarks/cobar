...
public class BitOrTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9998f060e48a06a03d0() {
    ...
    final BitOr thisObj = new BitOr(arrayList);
    ...
    Assert.assertNotNull(((BitOr) actual).getArguments());
    Assert.assertEquals(1, ((BitOr) actual).getArguments().size());
    Assert.assertNotNull(((BitOr) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((BitOr) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((BitOr) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((BitOr) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitOr) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitOr) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitOr) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((BitOr) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((BitOr) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((BitOr) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("BIT_OR", ((BitOr) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999c30ea3b2b934841b() {
    ...
    final BitOr actual = new BitOr(arg0);
    ...
    Assert.assertEquals("BIT_OR", actual.getFunctionName());
