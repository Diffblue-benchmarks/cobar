...
public class StdTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999bbb87268551a6f05() {
    ...
    final Std thisObj = new Std(arrayList);
    ...
    Assert.assertNotNull(((Std) actual).getArguments());
    Assert.assertEquals(1, ((Std) actual).getArguments().size());
    Assert.assertNotNull(((Std) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Std) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Std) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Std) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Std) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Std) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Std) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Std) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Std) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Std) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("STD", ((Std) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9998eabe5b0747ffa85() {
    ...
    Assert.assertEquals("STD", actual.getFunctionName());
