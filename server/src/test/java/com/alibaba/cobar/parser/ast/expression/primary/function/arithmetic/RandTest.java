...
public class RandTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9992d5f758921fa7902() {
    ...
    final Rand thisObj = new Rand(arrayList);
    ...
    Assert.assertNotNull(((Rand) actual).getArguments());
    Assert.assertEquals(1, ((Rand) actual).getArguments().size());
    Assert.assertNotNull(((Rand) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Rand) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Rand) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Rand) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rand) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rand) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rand) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Rand) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Rand) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Rand) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("RAND", ((Rand) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999daf306028b086a65() {
    ...
    final Rand actual = new Rand(arg0);
    ...
    Assert.assertEquals("RAND", actual.getFunctionName());
