...
public class PasswordTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9990ba0d5c03a705edf() {
    ...
    final Password thisObj = new Password(arrayList);
    ...
    Assert.assertNotNull(((Password) actual).getArguments());
    Assert.assertEquals(1, ((Password) actual).getArguments().size());
    Assert.assertNotNull(((Password) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Password) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Password) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Password) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Password) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Password) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Password) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Password) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Password) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Password) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("PASSWORD", ((Password) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999bac573f50765c9c0() {
    ...
    final Password actual = new Password(arg0);
    ...
    Assert.assertEquals("PASSWORD", actual.getFunctionName());
