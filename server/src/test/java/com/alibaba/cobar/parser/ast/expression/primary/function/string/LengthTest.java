...
public class LengthTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9991b84dcb16dab53e3() {
    ...
    final Length thisObj = new Length(arrayList);
    ...
    Assert.assertNotNull(((Length) actual).getArguments());
    Assert.assertEquals(1, ((Length) actual).getArguments().size());
    Assert.assertNotNull(((Length) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Length) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Length) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Length) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Length) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Length) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Length) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Length) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Length) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Length) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("LENGTH", ((Length) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9995d8ec3e5e7ffc459() {
    ...
    final Length actual = new Length(arg0);
    ...
    Assert.assertEquals("LENGTH", actual.getFunctionName());
