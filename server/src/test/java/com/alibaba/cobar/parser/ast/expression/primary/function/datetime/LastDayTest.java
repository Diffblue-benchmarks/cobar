...
public class LastDayTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99940c3610b13ad8aae() {
    ...
    final LastDay thisObj = new LastDay(arrayList);
    ...
    Assert.assertNotNull(((LastDay) actual).getArguments());
    Assert.assertEquals(1, ((LastDay) actual).getArguments().size());
    Assert.assertNotNull(((LastDay) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((LastDay) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((LastDay) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((LastDay) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((LastDay) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((LastDay) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((LastDay) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((LastDay) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((LastDay) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((LastDay) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("LAST_DAY", ((LastDay) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99972a6e39cbd845cd3() {
    ...
    final LastDay actual = new LastDay(arg0);
    ...
    Assert.assertEquals("LAST_DAY", actual.getFunctionName());
