...
public class SinTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999414b6d564add2ccc() {
    ...
    final Sin thisObj = new Sin(arrayList);
    ...
    Assert.assertNotNull(((Sin) actual).getArguments());
    Assert.assertEquals(1, ((Sin) actual).getArguments().size());
    Assert.assertNotNull(((Sin) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Sin) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Sin) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Sin) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sin) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sin) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sin) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Sin) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Sin) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Sin) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("SIN", ((Sin) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999bfa46e62f822c805() {
    ...
    Assert.assertEquals("SIN", actual.getFunctionName());
