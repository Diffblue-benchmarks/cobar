...
public class BenchmarkTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9993d163ef1807e9878() {
    ...
    final Benchmark thisObj = new Benchmark(arrayList);
    ...
    Assert.assertNotNull(((Benchmark) actual).getArguments());
    Assert.assertEquals(1, ((Benchmark) actual).getArguments().size());
    Assert.assertNotNull(((Benchmark) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Benchmark) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Benchmark) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Benchmark) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Benchmark) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Benchmark) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Benchmark) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Benchmark) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Benchmark) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Benchmark) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("BENCHMARK", ((Benchmark) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999484023a482c39e41() {
    ...
    final Benchmark actual = new Benchmark(arg0);
    ...
    Assert.assertEquals("BENCHMARK", actual.getFunctionName());
