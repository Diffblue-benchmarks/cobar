...
public class CotTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999d38ca3e0940663fe() {
    ...
    final Cot thisObj = new Cot(arrayList);
    ...
    Assert.assertNotNull(((Cot) actual).getArguments());
    Assert.assertEquals(1, ((Cot) actual).getArguments().size());
    Assert.assertNotNull(((Cot) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Cot) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Cot) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Cot) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Cot) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Cot) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Cot) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Cot) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Cot) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Cot) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("COT", ((Cot) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999f257941a1c39c23c() {
    ...
    Assert.assertEquals("COT", actual.getFunctionName());
