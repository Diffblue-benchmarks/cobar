...
public class CompressTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999ddfd7ee184f64689() {
    ...
    final Compress thisObj = new Compress(arrayList);
    ...
    Assert.assertNotNull(((Compress) actual).getArguments());
    Assert.assertEquals(1, ((Compress) actual).getArguments().size());
    Assert.assertNotNull(((Compress) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Compress) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Compress) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Compress) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Compress) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Compress) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Compress) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Compress) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Compress) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Compress) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("COMPRESS", ((Compress) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull99955f966483faea6bb() {
    ...
    final Compress actual = new Compress(arg0);
    ...
    Assert.assertEquals("COMPRESS", actual.getFunctionName());
