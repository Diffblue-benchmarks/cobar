...
public class SubdateTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99989eaa2569088aaf8() {
    ...
    final Subdate thisObj = new Subdate(arrayList);
    ...
    Assert.assertNotNull(((Subdate) actual).getArguments());
    Assert.assertEquals(1, ((Subdate) actual).getArguments().size());
    Assert.assertNotNull(((Subdate) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Subdate) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Subdate) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Subdate) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Subdate) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Subdate) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Subdate) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Subdate) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Subdate) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Subdate) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("SUBDATE", ((Subdate) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999ff806ebffd0b3e77() {
    ...
    final Subdate actual = new Subdate(arg0);
    ...
    Assert.assertEquals("SUBDATE", actual.getFunctionName());
