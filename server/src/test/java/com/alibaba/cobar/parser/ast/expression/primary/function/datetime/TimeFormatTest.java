...
public class TimeFormatTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999530b3a7a96cd8c39() {
    ...
    final TimeFormat thisObj = new TimeFormat(arrayList);
    ...
    Assert.assertNotNull(((TimeFormat) actual).getArguments());
    Assert.assertEquals(1, ((TimeFormat) actual).getArguments().size());
    Assert.assertNotNull(((TimeFormat) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((TimeFormat) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((TimeFormat) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((TimeFormat) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((TimeFormat) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((TimeFormat) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((TimeFormat) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((TimeFormat) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((TimeFormat) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((TimeFormat) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("TIME_FORMAT", ((TimeFormat) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9996b302714ecfc2c3d() {
    ...
    final TimeFormat actual = new TimeFormat(arg0);
    ...
    Assert.assertEquals("TIME_FORMAT", actual.getFunctionName());
