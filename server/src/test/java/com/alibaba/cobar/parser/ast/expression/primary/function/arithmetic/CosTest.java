...
public class CosTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999d63b502db3cff420() {
    ...
    final Cos thisObj = new Cos(arrayList);
    ...
    Assert.assertNotNull(((Cos) actual).getArguments());
    Assert.assertEquals(1, ((Cos) actual).getArguments().size());
    Assert.assertNotNull(((Cos) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Cos) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Cos) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Cos) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Cos) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Cos) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Cos) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Cos) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Cos) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Cos) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("COS", ((Cos) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999038d19041cd06f75() {
    ...
    Assert.assertEquals("COS", actual.getFunctionName());
