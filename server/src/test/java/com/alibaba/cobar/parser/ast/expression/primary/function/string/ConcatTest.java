...
public class ConcatTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull99984dc7e294fbc4181() {
    ...
    final Concat thisObj = new Concat(arrayList);
    ...
    Assert.assertNotNull(((Concat) actual).getArguments());
    Assert.assertEquals(1, ((Concat) actual).getArguments().size());
    Assert.assertNotNull(((Concat) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Concat) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Concat) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Concat) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Concat) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Concat) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Concat) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Concat) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Concat) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Concat) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("CONCAT", ((Concat) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9998f9df66541648f2f() {
    ...
    final Concat actual = new Concat(arg0);
    ...
    Assert.assertEquals("CONCAT", actual.getFunctionName());
