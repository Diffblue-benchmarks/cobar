...
public class HexTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull999fe9d9331bbea514e() {
    ...
    final Hex thisObj = new Hex(arrayList);
    ...
    Assert.assertNotNull(((Hex) actual).getArguments());
    Assert.assertEquals(1, ((Hex) actual).getArguments().size());
    Assert.assertNotNull(((Hex) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Hex) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Hex) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Hex) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Hex) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Hex) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Hex) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Hex) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Hex) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Hex) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("HEX", ((Hex) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull9991c5d7e639ee90fe2() {
    ...
    Assert.assertEquals("HEX", actual.getFunctionName());
