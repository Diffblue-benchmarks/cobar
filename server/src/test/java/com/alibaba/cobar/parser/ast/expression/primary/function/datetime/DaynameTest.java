...
public class DaynameTest {
  ...
  @Test
  public void constructFunctionInputNotNullOutputNotNull9999529d6745122fd88() {
    ...
    final Dayname thisObj = new Dayname(arrayList);
    ...
    Assert.assertNotNull(((Dayname) actual).getArguments());
    Assert.assertEquals(1, ((Dayname) actual).getArguments().size());
    Assert.assertNotNull(((Dayname) actual).getArguments().get(0));
    Assert.assertTrue(((ArithmeticAddExpression) ((Dayname) actual).getArguments().get(0)).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((Dayname) actual).getArguments().get(0)).getPrecedence());
    Assert.assertNotNull(((ArithmeticAddExpression) ((Dayname) actual).getArguments().get(0)).getLeftOprand());
    Assert.assertTrue(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayname) actual).getArguments().get(0)).getLeftOprand()).isLeftCombine());
    Assert.assertEquals(12, ((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayname) actual).getArguments().get(0)).getLeftOprand()).getPrecedence());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayname) actual).getArguments().get(0)).getLeftOprand()).getLeftOprand());
    Assert.assertNull(((ArithmeticAddExpression) ((ArithmeticAddExpression) ((Dayname) actual).getArguments().get(0)).getLeftOprand()).getRightOprand());
    Assert.assertEquals(((ArithmeticAddExpression) ((Dayname) actual).getArguments().get(0)).getLeftOprand(), ((ArithmeticAddExpression) ((Dayname) actual).getArguments().get(0)).getRightOprand());
    Assert.assertEquals("DAYNAME", ((Dayname) actual).getFunctionName());

  }

  // Test written by Diffblue Cover
  @Test
  public void constructorInputNotNullOutputNotNull999b922751ad05afc9d() {
    ...
    final Dayname actual = new Dayname(arg0);
    ...
    Assert.assertEquals("DAYNAME", actual.getFunctionName());
