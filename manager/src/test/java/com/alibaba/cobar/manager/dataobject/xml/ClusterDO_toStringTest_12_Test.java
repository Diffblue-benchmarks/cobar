...
public class ClusterDO_toStringTest_12_Test {
  @Test
  public void toStringTest() throws Exception {
    ...
    // Act
    String actual = clusterDO.toString();

    // Assert
    Assert.assertEquals(
        "id:0|name:null|status:|deployContact:null|maintContact:null|onlineTime:null|deployDesc:null|sortId:0", actual);
