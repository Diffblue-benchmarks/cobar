...
public class DataNodesStatus_setDataSourceTest_2_Test {
  @Test
  public void setDataSourceTest() throws Exception {
    // Arrange
    DataNodesStatus dataNodesStatus = new DataNodesStatus();
    String dataSource = "aaaaa";

    // Act
    dataNodesStatus.setDataSource(dataSource);
    ...
    String dataSource1 = dataNodesStatus.getDataSource();
    ...
    Assert.assertEquals("aaaaa", dataSource1);
