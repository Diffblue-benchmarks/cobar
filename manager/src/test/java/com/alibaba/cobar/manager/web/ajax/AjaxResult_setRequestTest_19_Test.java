...
public class AjaxResult_setRequestTest_19_Test {
  @Test
  public void setRequestTest() throws Exception {
    // Arrange
    AjaxResult ajaxResult = new AjaxResult();
    long request = 1L;

    // Act
    ajaxResult.setRequest(request);
