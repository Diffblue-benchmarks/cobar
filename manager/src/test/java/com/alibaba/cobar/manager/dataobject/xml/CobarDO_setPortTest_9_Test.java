...
public class CobarDO_setPortTest_9_Test {
  @Test
  public void setPortTest() throws Exception {
    ...
    Assert.assertEquals(1, cobarDO.getPort());
    ...
    Assert.assertEquals(
        "id:0|clusterId:0|name:null|status:null|host:null|port:1|user:null|password:null|time_diff:null",
        toStringResult);
