...
public class CommandStatus_setStmtCloseTest_14_Test {
  @Test
  public void setStmtCloseTest() throws Exception {
    // Arrange
    CommandStatus commandStatus = new CommandStatus();
    long stmtClose = 1L;

    // Act
    commandStatus.setStmtClose(stmtClose);
    ...
    Assert.assertEquals(1L, commandStatus.getStmtClose());
