...
public class UserDAOImple_addUserTest_3_Test {
  @Test
  public void addUserTest() throws Exception {
    ...
    Assert.assertEquals("id:-9223372036854775807|realname:null|usernamenull|password:null|user_role:null|status:null",
        toStringResult);
