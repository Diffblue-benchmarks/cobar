...
public class ConnectionStatus_setAttempsCountTest_24_Test {
  @Test
  public void setAttempsCountTest() throws Exception {
    // Arrange
    ConnectionStatus connectionStatus = new ConnectionStatus();
    int attempsCount = 1;

    // Act
    connectionStatus.setAttempsCount(attempsCount);
    ...
    int attempsCount1 = connectionStatus.getAttempsCount();
    ...
    Assert.assertEquals(1, attempsCount1);
