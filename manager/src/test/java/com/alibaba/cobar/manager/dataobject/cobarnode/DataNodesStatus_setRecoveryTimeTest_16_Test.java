...
public class DataNodesStatus_setRecoveryTimeTest_16_Test {
  @Test
  public void setRecoveryTimeTest() throws Exception {
    // Arrange
    DataNodesStatus dataNodesStatus = new DataNodesStatus();
    long recoveryTime = 1L;

    // Act
    dataNodesStatus.setRecoveryTime(recoveryTime);
    ...
    Assert.assertEquals(1L, dataNodesStatus.getRecoveryTime());
