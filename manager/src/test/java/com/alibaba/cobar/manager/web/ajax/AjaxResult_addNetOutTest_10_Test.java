...
public class AjaxResult_addNetOutTest_10_Test {
  @Test
  public void addNetOutTest() throws Exception {
    // Arrange
    AjaxResult ajaxResult = new AjaxResult();
    long netOut = 1L;

    // Act
    ajaxResult.addNetOut(netOut);
    ...
    Assert.assertEquals(1L, ajaxResult.getNetOut());
