...
public class ThreadPoolStatus_getCompletedTaskTest_11_Test {
  @Test
  public void getCompletedTaskTest() throws Exception {
    // Arrange
    ThreadPoolStatus threadPoolStatus = new ThreadPoolStatus();

    // Act
    long actual = threadPoolStatus.getCompletedTask();
