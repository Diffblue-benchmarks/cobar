...
public class AjaxResult_setNetOut_derivTest_34_Test {
  @Test
  public void setNetOut_derivTest() throws Exception {
    // Arrange
    AjaxResult ajaxResult = new AjaxResult();
    String netOut_deriv = "aaaaa";

    // Act
    ajaxResult.setNetOut_deriv(netOut_deriv);

    // Assert
    int schema = ajaxResult.getSchema();
    int active = ajaxResult.getActive();
    String netOut_deriv1 = ajaxResult.getNetOut_deriv();
    ...
    Assert.assertEquals("aaaaa", netOut_deriv1);
