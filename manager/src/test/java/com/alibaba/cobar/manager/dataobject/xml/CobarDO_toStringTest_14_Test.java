...
public class CobarDO_toStringTest_14_Test {
  @Test
  public void toStringTest() throws Exception {
    ...
    // Act
    String actual = cobarDO.toString();

    // Assert
    Assert.assertEquals(
        "id:0|clusterId:0|name:null|status:null|host:null|port:0|user:null|password:null|time_diff:null", actual);
