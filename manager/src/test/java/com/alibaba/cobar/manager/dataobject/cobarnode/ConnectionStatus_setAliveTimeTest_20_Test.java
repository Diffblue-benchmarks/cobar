...
public class ConnectionStatus_setAliveTimeTest_20_Test {
  @Test
  public void setAliveTimeTest() throws Exception {
    // Arrange
    ConnectionStatus connectionStatus = new ConnectionStatus();
    long aliveTime = 1L;

    // Act
    connectionStatus.setAliveTime(aliveTime);
    ...
    Assert.assertEquals(1L, connectionStatus.getAliveTime());
