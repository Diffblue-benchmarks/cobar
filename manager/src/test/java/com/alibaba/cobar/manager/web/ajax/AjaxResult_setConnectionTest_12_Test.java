...
public class AjaxResult_setConnectionTest_12_Test {
  @Test
  public void setConnectionTest() throws Exception {
    ...
    // Act
    ajaxResult.setConnection(connection);
    ...
    long connection1 = ajaxResult.getConnection();
    ...
    Assert.assertEquals(1L, connection1);
