...
public class ConnectionStatus_setNetInTest_1_Test {
  @Test
  public void setNetInTest() throws Exception {
    // Arrange
    ConnectionStatus connectionStatus = new ConnectionStatus();
    long netIn = 1L;

    // Act
    connectionStatus.setNetIn(netIn);
    ...
    long netIn1 = connectionStatus.getNetIn();
