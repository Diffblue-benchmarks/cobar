...
public class CommandStatus_setQuitTest_7_Test {
  @Test
  public void setQuitTest() throws Exception {
    // Arrange
    CommandStatus commandStatus = new CommandStatus();
    long quit = 1L;

    // Act
    commandStatus.setQuit(quit);
    ...
    long quit1 = commandStatus.getQuit();
