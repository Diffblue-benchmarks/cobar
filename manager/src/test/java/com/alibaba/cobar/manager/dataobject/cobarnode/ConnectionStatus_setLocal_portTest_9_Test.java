...
public class ConnectionStatus_setLocal_portTest_9_Test {
  @Test
  public void setLocal_portTest() throws Exception {
    // Arrange
    ConnectionStatus connectionStatus = new ConnectionStatus();
    int local_port = 1;

    // Act
    connectionStatus.setLocal_port(local_port);
    ...
    int local_port1 = connectionStatus.getLocal_port();
    ...
    Assert.assertEquals(1, local_port1);
