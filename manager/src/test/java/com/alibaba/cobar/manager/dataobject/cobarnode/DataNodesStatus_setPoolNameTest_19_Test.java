...
public class DataNodesStatus_setPoolNameTest_19_Test {
  @Test
  public void setPoolNameTest() throws Exception {
    // Arrange
    DataNodesStatus dataNodesStatus = new DataNodesStatus();
    String poolName = "aaaaa";

    // Act
    dataNodesStatus.setPoolName(poolName);
    ...
    String poolName1 = dataNodesStatus.getPoolName();
    ...
    Assert.assertEquals("aaaaa", poolName1);
