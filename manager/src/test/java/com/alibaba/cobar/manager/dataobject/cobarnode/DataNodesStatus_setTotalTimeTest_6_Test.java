...
public class DataNodesStatus_setTotalTimeTest_6_Test {
  @Test
  public void setTotalTimeTest() throws Exception {
    // Arrange
    DataNodesStatus dataNodesStatus = new DataNodesStatus();
    long totalTime = 1L;

    // Act
    dataNodesStatus.setTotalTime(totalTime);
    ...
    long totalTime1 = dataNodesStatus.getTotalTime();
    ...
    Assert.assertEquals(1L, totalTime1);
