...
public class ConnectionStatus_setSendQueueTest_13_Test {
  @Test
  public void setSendQueueTest() throws Exception {
    // Arrange
    ConnectionStatus connectionStatus = new ConnectionStatus();
    int sendQueue = 1;

    // Act
    connectionStatus.setSendQueue(sendQueue);
    ...
    int sendQueue1 = connectionStatus.getSendQueue();
    Assert.assertNotNull(toStringResult);
    Assert.assertEquals(0L, connectionStatus.getAliveTime());
    Assert.assertEquals(1, sendQueue1);
