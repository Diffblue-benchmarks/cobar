...
public class AjaxResult_setRequest_derivTest_13_Test {
  @Test
  public void setRequest_derivTest() throws Exception {
    // Arrange
    AjaxResult ajaxResult = new AjaxResult();
    String reCount_deriv = "aaaaa";

    // Act
    ajaxResult.setRequest_deriv(reCount_deriv);
    ...
    Assert.assertEquals("aaaaa", request_deriv);
