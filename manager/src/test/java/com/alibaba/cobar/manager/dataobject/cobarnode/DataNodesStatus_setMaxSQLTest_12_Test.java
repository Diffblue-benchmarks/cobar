...
public class DataNodesStatus_setMaxSQLTest_12_Test {
  @Test
  public void setMaxSQLTest() throws Exception {
    // Arrange
    DataNodesStatus dataNodesStatus = new DataNodesStatus();
    long maxSQL = 1L;

    // Act
    dataNodesStatus.setMaxSQL(maxSQL);
    ...
    long maxSQL1 = dataNodesStatus.getMaxSQL();
    ...
    Assert.assertEquals(1L, maxSQL1);
